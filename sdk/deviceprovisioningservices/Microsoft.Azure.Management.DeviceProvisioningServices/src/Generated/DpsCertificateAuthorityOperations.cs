...
namespace Microsoft.Azure.Management.DeviceProvisioningServices
{
    ...
    /// </summary>
    internal partial class DpsCertificateAuthorityOperations : IServiceOperations<IotDpsClient>, IDpsCertificateAuthorityOperations
    {
        /// <summary>
        /// Initializes a new instance of the DpsCertificateAuthorityOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal DpsCertificateAuthorityOperations(IotDpsClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<CertificateResponse>> GetWithHttpMessagesAsync(string certificateName, string resourceGroupName, string provisioningServiceName, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/provisioningServices/{provisioningServiceName}/certificateAuthorities/{certificateName}").ToString();
        ...
        public async Task<AzureOperationResponse<CertificateListDescription>> ListWithHttpMessagesAsync(string resourceGroupName, string provisioningServiceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/provisioningServices/{provisioningServiceName}/certificateAuthorities").ToString();
            _url = _url.Replace("{subscriptionId}", System.Uri.EscapeDataString(Client.SubscriptionId));
            _url = _url.Replace("{resourceGroupName}", System.Uri.EscapeDataString(resourceGroupName));
            _url = _url.Replace("{provisioningServiceName}", System.Uri.EscapeDataString(provisioningServiceName));
            List<string> _queryParameters = new List<string>();
