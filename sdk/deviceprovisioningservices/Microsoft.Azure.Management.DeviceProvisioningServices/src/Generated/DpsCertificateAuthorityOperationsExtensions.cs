...
namespace Microsoft.Azure.Management.DeviceProvisioningServices
{
    ...
    /// <summary>
    /// Extension methods for DpsCertificateAuthorityOperations.
    /// </summary>
    public static partial class DpsCertificateAuthorityOperationsExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static CertificateResponse Get(this IDpsCertificateAuthorityOperations operations, string certificateName, string resourceGroupName, string provisioningServiceName, string ifMatch = default(string))
            {
            ...
            /// </param>
            public static async Task<CertificateResponse> GetAsync(this IDpsCertificateAuthorityOperations operations, string certificateName, string resourceGroupName, string provisioningServiceName, string ifMatch = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static CertificateResponse CreateOrUpdate(this IDpsCertificateAuthorityOperations operations, string resourceGroupName, string provisioningServiceName, string certificateName, CertificateBodyDescription certificateDescription, string ifMatch = default(string))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<CertificateResponse> CreateOrUpdateAsync(this IDpsCertificateAuthorityOperations operations, string resourceGroupName, string provisioningServiceName, string certificateName, CertificateBodyDescription certificateDescription, string ifMatch = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DeleteAsync(this IDpsCertificateAuthorityOperations operations, string resourceGroupName, string ifMatch, string provisioningServiceName, string certificateName, string certificatename = default(string), byte[] certificaterawBytes = default(byte[]), bool? certificateisVerified = default(bool?), string certificatepurpose = default(string), System.DateTime? certificatecreated = default(System.DateTime?), System.DateTime? certificatelastUpdated = default(System.DateTime?), bool? certificatehasPrivateKey = default(bool?), string certificatenonce = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static CertificateListDescription List(this IDpsCertificateAuthorityOperations operations, string resourceGroupName, string provisioningServiceName)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<CertificateListDescription> ListAsync(this IDpsCertificateAuthorityOperations operations, string resourceGroupName, string provisioningServiceName, CancellationToken cancellationToken = default(CancellationToken))
            {
