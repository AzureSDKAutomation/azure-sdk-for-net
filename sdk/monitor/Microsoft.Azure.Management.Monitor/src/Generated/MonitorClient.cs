...
namespace Microsoft.Azure.Management.Monitor
{
    ...
    public partial class MonitorClient : ServiceClient<MonitorClient>, IMonitorClient, IAzureClient
    {
        ...
        /// True: will dispose the provided httpClient on calling MonitorClient.Dispose(). False: will not dispose provided httpClient</param>
        protected MonitorClient(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public MonitorClient(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
