...
namespace Microsoft.Azure.Management.Monitor.Models
{
    ...
    public partial class Metric
    {
        ...
        public Metric(string id, string type, LocalizableString name, string displayDescription, string unit, IList<TimeSeriesElement> timeseries, string errorCode = default(string))
        {
            Id = id;
            Type = type;
            Name = name;
