...
namespace Microsoft.Azure.Management.Quota
{
    ...
    internal partial class QuotaOperations : IServiceOperations<AzureQuotaExtensionAPIClient>, IQuotaOperations
    {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<object>> CreateOrUpdateWithHttpMessagesAsync(string resourceName, CurrentQuotaLimitBase createQuotaRequest, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send Request
            AzureOperationResponse<object> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceName, createQuotaRequest, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<object>> UpdateWithHttpMessagesAsync(string resourceName, CurrentQuotaLimitBase createQuotaRequest, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send Request
            AzureOperationResponse<object> _response = await BeginUpdateWithHttpMessagesAsync(resourceName, createQuotaRequest, customHeaders, cancellationToken).ConfigureAwait(false);
            return await Client.GetPutOrPatchOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<object>> BeginCreateOrUpdateWithHttpMessagesAsync(string resourceName, CurrentQuotaLimitBase createQuotaRequest, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ResourceUrl == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ResourceUrl");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<object>> BeginUpdateWithHttpMessagesAsync(string resourceName, CurrentQuotaLimitBase createQuotaRequest, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ResourceUrl == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ResourceUrl");
