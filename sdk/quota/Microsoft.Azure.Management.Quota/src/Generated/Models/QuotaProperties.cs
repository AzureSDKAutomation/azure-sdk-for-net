...
namespace Microsoft.Azure.Management.Quota.Models
{
    ...
    public partial class QuotaProperties
    {
        ...
        public QuotaProperties(int? limit = default(int?), int? currentValue = default(int?), string unit = default(string), ResourceName name = default(ResourceName), object resourceType = default(object), string quotaPeriod = default(string), bool? isQuotaAvailable = default(bool?), object properties = default(object))
        {
            Limit = limit;
