...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ManagedServerSecurityAlertPolicy : ProxyResource
    {
        ...
        /// policy.</param>
        public ManagedServerSecurityAlertPolicy(SecurityAlertsPolicyState state, string id = default(string), string name = default(string), string type = default(string), System.DateTime? creationTime = default(System.DateTime?))
            : base(id, name, type)
        {
            State = state;
