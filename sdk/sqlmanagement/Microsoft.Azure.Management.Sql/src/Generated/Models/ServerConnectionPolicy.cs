...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ServerConnectionPolicy : ProxyResource
    {
        ...
        /// experience.</param>
        public ServerConnectionPolicy(ServerConnectionType connectionType, string id = default(string), string name = default(string), string type = default(string), string location = default(string), string kind = default(string))
            : base(id, name, type)
        {
            Location = location;
            Kind = kind;
