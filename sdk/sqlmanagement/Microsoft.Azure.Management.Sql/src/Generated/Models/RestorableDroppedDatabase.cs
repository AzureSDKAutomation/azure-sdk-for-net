...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class RestorableDroppedDatabase : ProxyResource
    {
        ...
        /// <param name="backupStorageAccountType">The backup storage account
        /// type.</param>
        public RestorableDroppedDatabase(string id = default(string), string name = default(string), string type = default(string), Sku sku = default(Sku), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string databaseName = default(string), long? maxSizeBytes = default(long?), string elasticPoolId = default(string), System.DateTime? creationDate = default(System.DateTime?), System.DateTime? deletionDate = default(System.DateTime?), System.DateTime? earliestRestoreDate = default(System.DateTime?), string backupStorageAccountType = default(string))
            : base(id, name, type)
        {
            Sku = sku;
            Location = location;
            ...
            BackupStorageAccountType = backupStorageAccountType;
            CustomInit();
        }
        ...
        /// <summary>
        /// Gets the backup storage account type.
        /// </summary>
        [JsonProperty(PropertyName = "properties.backupStorageAccountType")]
        public string BackupStorageAccountType { get; private set; }
