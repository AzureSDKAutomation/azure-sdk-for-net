...
namespace Microsoft.Azure.Management.Support
{
    ...
    public partial class MicrosoftSupportClient : ServiceClient<MicrosoftSupportClient>, IMicrosoftSupportClient, IAzureClient
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<SupportTicketResourceIdLookUpResponse>> SupportTicketResourceIdLookUpWithHttpMessagesAsync(SupportTicketResourceIdLookupRequest supportTicketResourceIdLookupRequest, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.ApiVersion");
            }
            if (supportTicketResourceIdLookupRequest == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "supportTicketResourceIdLookupRequest");
            }
            // Tracing
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("supportTicketResourceIdLookupRequest", supportTicketResourceIdLookupRequest);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "SupportTicketResourceIdLookUp", tracingParameters);
            }
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Support/supportTickets/resourceIdLookUp").ToString();
            ...
            if(supportTicketResourceIdLookupRequest != null)
            {
                _requestContent = SafeJsonConvert.SerializeObject(supportTicketResourceIdLookupRequest, SerializationSettings);
            ...
            // Create Result
            var _result = new AzureOperationResponse<SupportTicketResourceIdLookUpResponse>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<SupportTicketResourceIdLookUpResponse>(_responseContent, DeserializationSettings);
                }
