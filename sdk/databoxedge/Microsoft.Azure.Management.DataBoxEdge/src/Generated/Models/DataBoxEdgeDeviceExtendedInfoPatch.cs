...
namespace Microsoft.Azure.Management.DataBoxEdge.Models
{
    ...
    public partial class DataBoxEdgeDeviceExtendedInfoPatch
    {
        ...
        /// Integrity Key stored in the Client Key Vault</param>
        public DataBoxEdgeDeviceExtendedInfoPatch(string clientSecretStoreId = default(string), string clientSecretStoreUrl = default(string), string channelIntegrityKeyName = default(string), string channelIntegrityKeyVersion = default(string))
        {
