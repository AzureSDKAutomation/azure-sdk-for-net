...
namespace Microsoft.Azure.Management.DataBoxEdge
{
    ...
    /// </summary>
    internal partial class NodesOperations : IServiceOperations<DataBoxEdgeManagementClient>, INodesOperations
    {
        /// <summary>
        /// Initializes a new instance of the NodesOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal NodesOperations(DataBoxEdgeManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<NodeList>> ListByDataBoxEdgeDeviceWithHttpMessagesAsync(string deviceName, string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/nodes").ToString();
