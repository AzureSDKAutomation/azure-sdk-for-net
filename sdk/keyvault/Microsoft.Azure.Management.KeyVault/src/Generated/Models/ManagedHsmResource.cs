...
namespace Microsoft.Azure.Management.KeyVault.Models
{
    ...
    public partial class ManagedHsmResource : IResource
    {
        ...
        public ManagedHsmResource(string id = default(string), string name = default(string), string type = default(string), string location = default(string), ManagedHsmSku sku = default(ManagedHsmSku), IDictionary<string, string> tags = default(IDictionary<string, string>), SystemDataModel systemData = default(SystemDataModel))
        {
            Id = id;
            Name = name;
            Type = type;
