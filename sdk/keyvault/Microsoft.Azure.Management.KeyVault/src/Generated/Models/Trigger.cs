...
namespace Microsoft.Azure.Management.KeyVault.Models
{
    ...
    public partial class Trigger
    {
        ...
        /// to rotate the key. It should be in ISO8601 format. Eg: 'P90D',
        /// 'P1Y'.</param>
        /// <param name="timeBeforeExpiry">The time duration before key
        /// expiring to rotate the key. It should be in ISO8601 format. Eg:
        /// 'P90D', 'P1Y'.</param>
        ...
        /// key. It should be in ISO8601 format. Eg: 'P90D', 'P1Y'.
        /// </summary>
        [JsonProperty(PropertyName = "timeAfterCreate")]
        public string TimeAfterCreate { get; set; }

        /// <summary>
        /// Gets or sets the time duration before key expiring to rotate the
        /// key. It should be in ISO8601 format. Eg: 'P90D', 'P1Y'.
        /// </summary>
