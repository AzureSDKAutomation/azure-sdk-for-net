...
namespace Microsoft.Azure.Management.DomainServices.Models
{
    ...
    public partial class DomainService : Resource
    {
        ...
        /// Type</param>
        /// <param name="domainServiceSku">Sku Type</param>
        ...
        public DomainService(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string etag = default(string), ResourceSku sku = default(ResourceSku), int? version = default(int?), string tenantId = default(string), string domainName = default(string), string deploymentId = default(string), string syncOwner = default(string), IList<ReplicaSet> replicaSets = default(IList<ReplicaSet>), LdapsSettings ldapsSettings = default(LdapsSettings), ResourceForestSettings resourceForestSettings = default(ResourceForestSettings), DomainSecuritySettings domainSecuritySettings = default(DomainSecuritySettings), string domainConfigurationType = default(string), string domainServiceSku = default(string), string filteredSync = default(string), NotificationSettings notificationSettings = default(NotificationSettings), MigrationProperties migrationProperties = default(MigrationProperties), string provisioningState = default(string))
            : base(id, name, type, location, tags, etag, sku)
        {
            Version = version;
            TenantId = tenantId;
            ...
            DomainServiceSku = domainServiceSku;
        ...
        public string DomainServiceSku { get; set; }
