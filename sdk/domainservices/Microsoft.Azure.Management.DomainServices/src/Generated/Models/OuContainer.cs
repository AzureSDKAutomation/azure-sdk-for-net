...
namespace Microsoft.Azure.Management.DomainServices.Models
{
    ...
    public partial class OuContainer : Resource
    {
        ...
        public OuContainer(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string etag = default(string), ResourceSku sku = default(ResourceSku), string tenantId = default(string), string domainName = default(string), string deploymentId = default(string), string containerId = default(string), IList<ContainerAccount> accounts = default(IList<ContainerAccount>), string serviceStatus = default(string), string distinguishedName = default(string), string provisioningState = default(string))
