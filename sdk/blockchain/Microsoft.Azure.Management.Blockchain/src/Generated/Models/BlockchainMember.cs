...
namespace Microsoft.Azure.Management.Blockchain.Models
{
    ...
    public partial class BlockchainMember : TrackedResource
    {
        ...
        /// service.</param>
        /// <param name="kind">The Kind of Blockchain Protocol</param>
        ...
        /// <param name="nodeProvisioningState">Gets or sets Node Provisioning
        /// state of default transaction node. Possible values include:
        /// 'NotSpecified', 'Updating', 'Deleting', 'Succeeded',
        /// 'Failed'</param>
        /// <param name="egressIP">Gets or sets Node Provisioning state of
        /// default transaction node. Possible values include: 'NotSpecified',
        ...
        public BlockchainMember(string id = default(string), string name = default(string), string type = default(string), string location = default(string), string kind = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string protocol = default(string), BlockchainMemberNodesSku validatorNodesSku = default(BlockchainMemberNodesSku), string provisioningState = default(string), string nodeProvisioningState = default(string), string egressIP = default(string), string dns = default(string), string userName = default(string), string password = default(string), string consortium = default(string), string consortiumManagementAccountAddress = default(string), string consortiumManagementAccountPassword = default(string), string consortiumRole = default(string), string consortiumMemberDisplayName = default(string), string rootContractAddress = default(string), string publicKey = default(string), IList<FirewallRule> firewallRules = default(IList<FirewallRule>), Sku sku = default(Sku))
            : base(id, name, type, location, kind, tags)
        {
            Protocol = protocol;
            ValidatorNodesSku = validatorNodesSku;
            ProvisioningState = provisioningState;
            NodeProvisioningState = nodeProvisioningState;
            EgressIP = egressIP;
            Dns = dns;
            UserName = userName;
            Password = password;
        ...
        /// <summary>
        /// Gets or sets Node Provisioning state of default transaction node.
        /// Possible values include: 'NotSpecified', 'Updating', 'Deleting',
        /// 'Succeeded', 'Failed'
        /// </summary>
        [JsonProperty(PropertyName = "properties.nodeProvisioningState")]
        public string NodeProvisioningState { get; private set; }
        ...
        /// 'Succeeded', 'Failed'
        /// </summary>
        [JsonProperty(PropertyName = "properties.egressIP")]
