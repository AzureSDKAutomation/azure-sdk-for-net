...
namespace Microsoft.Azure.Management.Blockchain.Models
{
    ...
    public partial class TrackedResource : Resource
    {
        ...
        public TrackedResource(string id = default(string), string name = default(string), string type = default(string), string location = default(string), string kind = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
            : base(id, name, type)
        {
            Location = location;
            Kind = kind;
        ...
        /// <summary>
        /// Gets the Kind of Blockchain Protocol
        /// </summary>
