...
namespace Microsoft.Azure.Management.Analysis.Models
{
    ...
    public partial class OperationStatus
    {
        ...
        /// any.</param>
        public OperationStatus(string id = default(string), string name = default(string), string startTime = default(string), string endTime = default(string), string status = default(string), ErrorObject error = default(ErrorObject))
        {
            Id = id;
            Name = name;
            StartTime = startTime;
