...
namespace Microsoft.Azure.Management.MarketplaceOrdering
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<MarketplaceOrderingAgreementsClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(MarketplaceOrderingAgreementsClient client)
        {
            if (client == null)
            {
