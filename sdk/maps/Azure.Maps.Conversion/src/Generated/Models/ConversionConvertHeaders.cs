...
namespace Azure.Maps.Conversion.Models
{
    ...
    /// <summary>
    /// Defines headers for Convert operation.
    /// </summary>
    public partial class ConversionConvertHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ConversionConvertHeaders class.
        /// </summary>
        public ConversionConvertHeaders()
        {
            CustomInit();
        }
        ...
        public ConversionConvertHeaders(string resourceLocation = default(string), string operationLocation = default(string))
        {
