...
namespace Azure.Maps.Mobility
{
    ...
    /// <summary>
    /// Extension methods for MobilityOperations.
    /// </summary>
    public static partial class MobilityOperationsExtensions
    {
            /// <summary>
            /// **Metro Area API**
            ///
            ...
            /// separated string composed by latitude followed by longitude, e.g.
            /// "47.641268,-122.125679”. Possible values include: 'position', 'countryCode'
            /// </param>
            /// <param name='language'>
            ...
            /// </param>
            public static async Task<MetroAreaResponse> GetMetroAreaPreviewAsync(this IMobilityOperations operations, string query, string queryType = default(string), string language = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetMetroAreaPreviewWithHttpMessagesAsync(query, queryType, language, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MetroAreaInfoResponse> GetMetroAreaInfoPreviewAsync(this IMobilityOperations operations, int query, IList<string> detailType, string language = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetMetroAreaInfoPreviewWithHttpMessagesAsync(query, detailType, language, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<NearbyTransitResponse> GetNearbyTransitPreviewAsync(this IMobilityOperations operations, string query, int? metroId = default(int?), int? limit = default(int?), int? radius = default(int?), string objectType = default(string), string language = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetNearbyTransitPreviewWithHttpMessagesAsync(query, metroId, limit, radius, objectType, language, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TransitLineInfoResponse> GetTransitLineInfoPreviewAsync(this IMobilityOperations operations, string query, int? metroId = default(int?), IList<string> detailType = default(IList<string>), string language = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetTransitLineInfoPreviewWithHttpMessagesAsync(query, metroId, detailType, language, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TransitStopInfoResponse> GetTransitStopInfoPreviewAsync(this IMobilityOperations operations, string query, int? metroId = default(int?), string queryType = default(string), IList<string> detailType = default(IList<string>), string language = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetTransitStopInfoPreviewWithHttpMessagesAsync(query, metroId, queryType, detailType, language, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// comma separated string composed by latitude followed by longitude, e.g.,
            /// "47.641268,-122.125679”. Possible values include: 'position', 'stopId',
            /// 'stopKey'
            /// </param>
            ...
            /// possible; as a comma separated list. If valid trip isn’t found with the
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TransitRouteResponse> GetTransitRoutePreviewAsync(this IMobilityOperations operations, string origin, string destination, int? metroId = default(int?), string originType = default(string), string destinationType = default(string), IList<string> modeType = default(IList<string>), IList<string> transitType = default(IList<string>), IList<string> agency = default(IList<string>), string agencyType = default(string), string time = default(string), string timeType = default(string), string routeType = default(string), string bikeType = default(string), string language = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetTransitRoutePreviewWithHttpMessagesAsync(origin, destination, metroId, originType, destinationType, modeType, transitType, agency, agencyType, time, timeType, routeType, bikeType, language, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TransitItineraryResponse> GetTransitItineraryPreviewAsync(this IMobilityOperations operations, string query, IList<string> detailType = default(IList<string>), string language = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetTransitItineraryPreviewWithHttpMessagesAsync(query, detailType, language, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// user’s location. The API supports parameters to request one or multiple
            ...
            /// mode per request is supported. By default queryType is set to be ‘stops’
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<RealTimeArrivalsResponse> GetRealTimeArrivalsPreviewAsync(this IMobilityOperations operations, string query, int? metroId = default(int?), string queryType = default(string), string stopQueryType = default(string), int? limit = default(int?), int? maxMinutesInFuture = default(int?), IList<string> transitType = default(IList<string>), IList<string> agency = default(IList<string>), string agencyType = default(string), int? timeoutInSeconds = default(int?), string language = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetRealTimeArrivalsPreviewWithHttpMessagesAsync(query, metroId, queryType, stopQueryType, limit, maxMinutesInFuture, transitType, agency, agencyType, timeoutInSeconds, language, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
