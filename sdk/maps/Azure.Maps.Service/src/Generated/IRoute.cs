...
namespace Azure.Maps.Service
{
    ...
    public partial interface IRoute
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse<RouteMatrixResponse>> GetRouteMatrixWithHttpMessagesAsync(string format, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse> PostRouteDirectionsBatchWithHttpMessagesAsync(BatchRequestBody postRouteDirectionsBatchRequestBody, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// ### Download Asynchronous Batch Results
        /// To download the async batch results you will issue a `GET` request
        /// to the batch download endpoint. This _download URL_ can be obtained
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse<RouteDirectionsBatchResponse>> GetRouteDirectionsBatchWithHttpMessagesAsync(string format, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// **Route Directions Batch API**
        ///
        ///
