...
namespace Azure.Maps.Service.Models
{
    ...
    public partial class SearchFuzzyBatchItemResponse
    {
        ...
        public SearchFuzzyBatchItemResponse(SearchCommonSummary summary = default(SearchCommonSummary), IList<SearchCommonResult> results = default(IList<SearchCommonResult>), ErrorDetail error = default(ErrorDetail))
        {
            Summary = summary;
            Results = results;
            Error = error;
