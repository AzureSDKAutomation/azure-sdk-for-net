...
namespace Azure.Maps.Service.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the TimezoneById class.
        /// </summary>
        public TimezoneById()
        {
            CustomInit();
        ...
        public TimezoneById(string id = default(string), IList<string> aliases = default(IList<string>), IList<CountryRecord> countries = default(IList<CountryRecord>), TimezoneNames names = default(TimezoneNames), ReferenceTimeById referenceTime = default(ReferenceTimeById), RepresentativePoint representativePoint = default(RepresentativePoint), IList<TimeTransition> timeTransitions = default(IList<TimeTransition>))
        {
            Id = id;
            Aliases = aliases;
            Countries = countries;
        ...
        public ReferenceTimeById ReferenceTime { get; set; }
