...
namespace Azure.Maps.Service.Models
{
    ...
    public partial class SearchAddressBatchItemResponse
    {
        ...
        public SearchAddressBatchItemResponse(SearchCommonSummary summary = default(SearchCommonSummary), IList<SearchCommonResult> results = default(IList<SearchCommonResult>), ErrorDetail error = default(ErrorDetail))
        {
            Summary = summary;
            Results = results;
            Error = error;
