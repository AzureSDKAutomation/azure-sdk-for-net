...
namespace Azure.Maps.Service
{
    ...
    /// <summary>
    /// Extension methods for Geolocation.
    /// </summary>
    public static partial class GeolocationExtensions
    {
            ...
            /// </param>
            public static async Task<IpAddressToLocationResult> GetIPToLocationPreviewAsync(this IGeolocation operations, string ip, CancellationToken cancellationToken = default(CancellationToken))
            {
