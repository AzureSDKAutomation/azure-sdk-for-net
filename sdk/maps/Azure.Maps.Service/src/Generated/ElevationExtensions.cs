...
namespace Azure.Maps.Service
{
    ...
    /// <summary>
    /// Extension methods for Elevation.
    /// </summary>
    public static partial class ElevationExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static async Task<PointsResult> GetDataForPointsAsync(this IElevation operations, IList<string> points, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PointsResult> PostDataForPointsAsync(this IElevation operations, IList<CoordinatesPairAbbreviated> pointsRequestBody, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<LinesResult> GetDataForPolylineAsync(this IElevation operations, IList<string> lines, int? samples = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<LinesResult> PostDataForPolylineAsync(this IElevation operations, IList<CoordinatesPairAbbreviated> linesRequestBody, int? samples = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BoundingBoxResult> GetDataForBoundingBoxAsync(this IElevation operations, IList<string> bounds, int rows, int columns, CancellationToken cancellationToken = default(CancellationToken))
            {
