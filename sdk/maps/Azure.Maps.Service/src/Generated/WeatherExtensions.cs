...
namespace Azure.Maps.Service
{
    ...
    public static partial class WeatherExtensions
    {
            ...
            /// </param>
            public static async Task<HourlyForecastResponse> GetHourlyForecastAsync(this IWeather operations, string query, string unit = default(string), int? duration = default(int?), string language = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetHourlyForecastWithHttpMessagesAsync(query, unit, duration, language, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MinuteForecastResponse> GetMinuteForecastAsync(this IWeather operations, string query, int? interval = default(int?), string language = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetMinuteForecastWithHttpMessagesAsync(query, interval, language, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<QuarterDayForecastResponse> GetQuarterDayForecastAsync(this IWeather operations, string query, string unit = default(string), int? duration = default(int?), string language = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetQuarterDayForecastWithHttpMessagesAsync(query, unit, duration, language, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<CurrentConditionsResponse> GetCurrentConditionsAsync(this IWeather operations, string query, string unit = default(string), string details = default(string), int? duration = default(int?), string language = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetCurrentConditionsWithHttpMessagesAsync(query, unit, details, duration, language, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DailyForecastResponse> GetDailyForecastAsync(this IWeather operations, string query, string unit = default(string), int? duration = default(int?), string language = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetDailyForecastWithHttpMessagesAsync(query, unit, duration, language, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<WeatherAlongRouteResponse> GetWeatherAlongRouteAsync(this IWeather operations, string query, string language = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetWeatherAlongRouteWithHttpMessagesAsync(query, language, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SevereWeatherAlertsResponse> GetSevereWeatherAlertsAsync(this IWeather operations, string query, string language = default(string), string details = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetSevereWeatherAlertsWithHttpMessagesAsync(query, language, details, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DailyIndicesResponse> GetDailyIndicesAsync(this IWeather operations, string query, string language = default(string), int? duration = default(int?), int? indexId = default(int?), int? indexGroupId = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetDailyIndicesWithHttpMessagesAsync(query, language, duration, indexId, indexGroupId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
