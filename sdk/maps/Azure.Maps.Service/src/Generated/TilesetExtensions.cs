...
namespace Azure.Maps.Service
{
    ...
    public static partial class TilesetExtensions
    {
            ...
            /// </param>
            public static async Task<TilesetCreateHeaders> CreateAsync(this ITileset operations, string datasetId, string description = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
