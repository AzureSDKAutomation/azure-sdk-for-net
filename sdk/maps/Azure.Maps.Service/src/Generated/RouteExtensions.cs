...
namespace Azure.Maps.Service
{
    ...
    public static partial class RouteExtensions
    {
            ...
            /// </param>
            public static async Task<RouteMatrixResponse> PostRouteMatrixAsync(this IRoute operations, PostRouteMatrixRequestBody postRouteMatrixRequestBody, bool? waitForResults = default(bool?), string computeTravelTimeFor = default(string), string sectionType = default(string), System.DateTime? arriveAt = default(System.DateTime?), System.DateTime? departAt = default(System.DateTime?), int? vehicleAxleWeight = default(int?), double? vehicleLength = default(double?), double? vehicleHeight = default(double?), double? vehicleWidth = default(double?), int? vehicleMaxSpeed = default(int?), int? vehicleWeight = default(int?), string windingness = default(string), string hilliness = default(string), string travelMode = default(string), IList<string> avoid = default(IList<string>), bool? traffic = default(bool?), string routeType = default(string), string vehicleLoadType = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<RouteMatrixResponse> GetRouteMatrixAsync(this IRoute operations, string format, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task PostRouteDirectionsBatchAsync(this IRoute operations, BatchRequestBody postRouteDirectionsBatchRequestBody, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.PostRouteDirectionsBatchWithHttpMessagesAsync(postRouteDirectionsBatchRequestBody, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<RouteDirectionsBatchResponse> GetRouteDirectionsBatchAsync(this IRoute operations, string format, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<RouteDirectionsBatchResponse> PostRouteDirectionsBatchSyncAsync(this IRoute operations, BatchRequestBody postRouteDirectionsBatchRequestBody, CancellationToken cancellationToken = default(CancellationToken))
            {
