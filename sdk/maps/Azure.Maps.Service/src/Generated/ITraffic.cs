...
namespace Azure.Maps.Service
{
    ...
    /// Traffic operations.
    /// </summary>
    public partial interface ITraffic
    {
        /// <summary>
        ...
        /// traffic flow. All tiles use the same grid system. Because the
        /// traffic tiles use transparent images, they can be layered on top of
        /// map tiles to create a compound  display. The Flow tiles use colors
        /// to indicate either the speed of traffic on different road segments,
        /// or the difference between that speed and the free-flow speed on the
        ...
        /// in the range: 0-22 (inclusive). For _vector_ tiles, value must be
        /// in the range: 0-22 (inclusive).
        ...
        /// default value is 10. This parameter is not valid when format is
        /// pbf.
        /// </param>
        ...
        /// **Applies to**: S0 and S1 pricing tiers.
        ///
        /// This service provides information about the speeds and travel times
        /// of the road fragment closest to the given coordinates. It is
        /// designed to work alongside the Flow layer of the Render Service to
        /// support clickable  flow data visualizations. With this API, the
        /// client side can connect any place in the map with flow data on the
        /// closest road and present it to the user.
        /// </summary>
        /// <param name='format'>
        ...
        /// different from the freeflow speeds. Possible values include:
        /// 'absolute', 'relative', 'relative-delay'
        /// </param>
        /// <param name='zoom'>
        ...
        /// </param>
        /// <param name='unit'>
        /// Unit of speed in KMPH or MPH. Possible values include: 'KMPH',
        /// 'MPH'
        /// </param>
        /// <param name='thickness'>
        /// The value of the width of the line representing traffic. This value
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse<TrafficFlowSegmentResult>> GetTrafficFlowSegmentWithHttpMessagesAsync(string format, string style, int zoom, string query, string unit = default(string), int? thickness = default(int?), bool? openLr = default(bool?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// incidents. All tiles use the same grid system. Because the traffic
        /// tiles use transparent images, they can be layered on top of map
        /// tiles to create a compound display. Traffic tiles render graphics
        /// to indicate traffic on the roads in the specified area.
        /// </summary>
        /// <param name='format'>
        /// Desired format of the response. Possible values are png &amp; pbf.
        /// Possible values include: 'png', 'pbf'
        /// </param>
        /// <param name='style'>
        /// The style to be used to render the tile. This parameter is not
        /// valid when format is pbf. Possible values include: 's1', 's2',
        /// 's3', 'night'
        /// </param>
        /// <param name='zoom'>
        /// Zoom level for the desired tile. For _raster_ tiles, value must be
        ...
        /// trafficState field. It is updated every minute, and is valid for
        /// two minutes before it times out. Use -1 to  get the most recent
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse<Stream,TrafficGetTrafficIncidentTileHeaders>> GetTrafficIncidentTileWithHttpMessagesAsync(string format, string style, int zoom, int xTileIndex, int yTileIndex, string trafficState = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// **Applies to**: S0 and S1 pricing tiers.
        ///
        /// This API provides information on traffic incidents inside a given
        /// bounding box, based on the current Traffic  Model ID. The Traffic
        /// Model ID is available to grant synchronization of data between
        /// calls and API's. The  Traffic Model ID is a key value for
        /// determining the currency of traffic incidents. It is updated every
        /// minute,  and is valid for two minutes before it times out. It is
        /// used in rendering  [incident
        ...
        /// This will have an effect on the coordinates of traffic incidents in
        /// the reply. Possible values include: 's1', 's2', 's3', 'night'
        /// </param>
        ...
        /// latitude/longitude pairs are used, then the `projection` parameter
        /// must be set to "EPSG4326".
        /// </param>
        ...
        /// the output language. Supported languages are ar, ca, cs, da, de,
        /// el, en, en-GB, en-US, es, et, fi, fr, he, hu, id, in*, it, lt, lv,
        ...
        /// (default) or
        /// [EPSG4326](http://spatialreference.org/ref/epsg/4326/). Possible
        /// values include: 'EPSG900913', 'EPSG4326'
        /// </param>
        /// <param name='geometries'>
        /// The type of vector geometry added to incidents (returned in the
        /// &lt;v&gt; element of the response). Possible values include:
        /// 'original', 'shifted'
        /// </param>
        ...
        /// (&lt;op&gt;) as well as the one shifted to the beginning of the
        /// traffic tube (&lt;op&gt;)
        /// </param>
        /// <param name='customHeaders'>
        /// The headers that will be added to request.
        ...
        /// **Applies to**: S0 and S1 pricing tiers.
        ///
        /// This API returns legal and technical information for the viewport
        /// described in the request. It should be called  by client
        /// applications whenever the viewport changes (for instance, through
        /// zooming, panning, going to a  location, or displaying a route). The
        /// request should contain the bounding box and zoom level of the
        /// viewport  whose information is needed. The return will contain map
        /// version information, as well as the current Traffic  Model ID and
        /// copyright IDs. The Traffic Model ID returned by the Viewport
        /// Description is used by other APIs to  retrieve last traffic
        ...
        /// describing it's corners (first pair for lower left corner and
        /// second for upper right). All values should be separated by commas
        /// (e.g., _minY,minX,maxY,maxX_). The maximum size of the bounding box
        /// that can be passed is dependent on the requested zoom level. The
        /// width and height cannot exceed 4092 pixels when rendered on the
        /// given zoom level.&lt;br&gt;&lt;br&gt;NOTE: Bounding boxes that
        /// cross the 180° meridian require special treatment. For such boxes,
        /// the eastern _maxX_ value will be negative, and thus less than the
        /// _minX_ value west of the 180° meridian. To address that, the value
        /// 40075016.6855874 should be added to the true _maxX_ value before it
        ...
        /// [EPSG900913](http://docs.openlayers.org/library/spherical_mercator.html)
        /// projection.&lt;br&gt;&lt;br&gt;Used in case the overview box/mini
        /// map has different copyright data than the main map. If there is no
        /// mini map, the same coordinates as `boundingBox` is used.
        /// </param>
