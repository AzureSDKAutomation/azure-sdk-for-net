...
namespace Azure.Maps.Featurestate.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the StatesetGetResponse class.
        /// </summary>
        public StatesetGetResponse()
        {
            CustomInit();
        }
        ...
        /// stateset.</param>
        public StatesetGetResponse(string description = default(string), IList<string> datasetIds = default(IList<string>), StylesObject statesetStyle = default(StylesObject))
        {
