...
namespace Azure.Maps.Tileset
{
    ...
    /// <summary>
    /// Extension methods for TilesetOperations.
    /// </summary>
    public static partial class TilesetOperationsExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static async Task<LongRunningOperationResult> CreateAsync(this ITilesetOperations operations, string datasetId, string description = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TilesetListResponse> ListAsync(this ITilesetOperations operations, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TilesetDetailInfo> GetAsync(this ITilesetOperations operations, string tilesetId, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DeleteAsync(this ITilesetOperations operations, string tilesetId, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<LongRunningOperationResult> GetOperationAsync(this ITilesetOperations operations, string operationId, CancellationToken cancellationToken = default(CancellationToken))
            {
