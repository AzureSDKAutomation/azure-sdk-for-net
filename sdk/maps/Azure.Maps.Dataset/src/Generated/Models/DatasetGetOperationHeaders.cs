...
namespace Azure.Maps.Dataset.Models
{
    ...
    /// </summary>
    public partial class DatasetGetOperationHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DatasetGetOperationHeaders class.
        /// </summary>
        public DatasetGetOperationHeaders()
        {
            CustomInit();
        }
        ...
        public DatasetGetOperationHeaders(string resourceLocation = default(string))
        {
