...
namespace Microsoft.Azure.Management.Marketplace
{
    ...
    public partial interface IPrivateStoreOfferOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<Offer>>> ListWithHttpMessagesAsync(string privateStoreId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
