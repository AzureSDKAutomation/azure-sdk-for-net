...
namespace Microsoft.Azure.Management.FrontDoor
{
    ...
    /// </summary>
    internal partial class PoliciesOperations : IServiceOperations<FrontDoorManagementClient>, IPoliciesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal PoliciesOperations(FrontDoorManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<WebApplicationFirewallPolicy>>> ListWithHttpMessagesAsync(string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/frontDoorWebApplicationFirewallPolicies").ToString();
