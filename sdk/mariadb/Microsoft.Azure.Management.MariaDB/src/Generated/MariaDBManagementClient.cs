...
namespace Microsoft.Azure.Management.MariaDB
{
    ...
    public partial class MariaDBManagementClient : ServiceClient<MariaDBManagementClient>, IMariaDBManagementClient, IAzureClient
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<QueryPerformanceInsightResetDataResult>> ResetQueryPerformanceInsightDataWithHttpMessagesAsync(string resourceGroupName, string serverName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMariaDB/servers/{serverName}/resetQueryPerformanceInsightData").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<QueryPerformanceInsightResetDataResult>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<QueryPerformanceInsightResetDataResult>(_responseContent, DeserializationSettings);
                }
