...
namespace Microsoft.Azure.Management.HybridCompute.Models
{
    ...
    public partial class MachineUpdate : UpdateResource
    {
        ...
        public MachineUpdate(IDictionary<string, string> tags = default(IDictionary<string, string>), string type = default(string), string principalId = default(string), string tenantId = default(string), LocationData locationData = default(LocationData), string privateLinkScopeResourceId = default(string))
            : base(tags)
        {
            Type = type;
