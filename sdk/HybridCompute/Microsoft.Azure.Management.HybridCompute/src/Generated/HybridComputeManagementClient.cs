...
namespace Microsoft.Azure.Management.HybridCompute
{
    ...
    public partial class HybridComputeManagementClient : ServiceClient<HybridComputeManagementClient>, IHybridComputeManagementClient, IAzureClient
    {
        ...
        /// True: will dispose the provided httpClient on calling HybridComputeManagementClient.Dispose(). False: will not dispose provided httpClient</param>
        ...
        /// </param>
        public async Task<AzureOperationResponse> UpgradeExtensionsWithHttpMessagesAsync(string resourceGroupName, string machineName, MachineExtensionUpgrade extensionUpgradeParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
        ...
        /// </return>
        public async Task<AzureOperationResponse> BeginUpgradeExtensionsWithHttpMessagesAsync(string resourceGroupName, string machineName, MachineExtensionUpgrade extensionUpgradeParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (ApiVersion == null)
            {
