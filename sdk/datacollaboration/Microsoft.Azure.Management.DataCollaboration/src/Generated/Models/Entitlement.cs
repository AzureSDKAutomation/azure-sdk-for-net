...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class Entitlement : ProxyDto
    {
        ...
        /// entitlement</param>
        public Entitlement(string resourceId, string resourceType, string subjectId, string id = default(string), string name = default(string), ProxyDtoSystemData systemData = default(ProxyDtoSystemData), string type = default(string), string description = default(string))
