...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class SynapseSparkScript : Script
    {
        ...
        /// resource</param>
        public SynapseSparkScript(string content, IList<string> sinks, IList<string> sources, string visibility, string id = default(string), string name = default(string), ProxyDtoSystemData systemData = default(ProxyDtoSystemData), string type = default(string), string provisioningState = default(string), string purpose = default(string), int? revision = default(int?), string scriptId = default(string))
