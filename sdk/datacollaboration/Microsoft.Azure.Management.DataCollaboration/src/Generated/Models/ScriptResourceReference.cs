...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class ScriptResourceReference : ResourceReference
    {
        ...
        public ScriptResourceReference(ResourceReferenceParticipantDetails participantDetails = default(ResourceReferenceParticipantDetails), string resourceId = default(string), string resourceName = default(string), string resourceType = default(string), ResourceReferenceSystemData systemData = default(ResourceReferenceSystemData), string purpose = default(string), int? revision = default(int?), string scriptId = default(string), string scriptKind = default(string), IList<string> sinks = default(IList<string>), IList<string> sources = default(IList<string>))
