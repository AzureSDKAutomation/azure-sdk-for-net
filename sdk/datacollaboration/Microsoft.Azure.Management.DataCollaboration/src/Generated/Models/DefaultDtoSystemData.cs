...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    /// </summary>
    public partial class DefaultDtoSystemData : SystemData
    {
        /// <summary>
        /// Initializes a new instance of the DefaultDtoSystemData class.
        /// </summary>
        public DefaultDtoSystemData()
        {
            CustomInit();
        }
        ...
        public DefaultDtoSystemData(System.DateTime? createdAt = default(System.DateTime?), string createdBy = default(string), string createdByType = default(string), System.DateTime? lastModifiedAt = default(System.DateTime?), string lastModifiedBy = default(string), string lastModifiedByType = default(string))
