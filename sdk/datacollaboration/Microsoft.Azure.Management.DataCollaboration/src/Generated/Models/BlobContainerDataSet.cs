...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class BlobContainerDataSet : DataSet
    {
        /// <summary>
        /// Initializes a new instance of the BlobContainerDataSet class.
        /// </summary>
        ...
        /// resource</param>
        public BlobContainerDataSet(string containerName, string storageAccountId, string id = default(string), string name = default(string), ProxyDtoSystemData systemData = default(ProxyDtoSystemData), string type = default(string), string dataSetId = default(string))
