...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class DataAssetReferenceResourceReference : ResourceReference
    {
        ...
        /// data asset reference</param>
        /// <param name="description">General Description of the data asset
        /// reference</param>
        public DataAssetReferenceResourceReference(ResourceReferenceParticipantDetails participantDetails = default(ResourceReferenceParticipantDetails), string resourceId = default(string), string resourceName = default(string), string resourceType = default(string), ResourceReferenceSystemData systemData = default(ResourceReferenceSystemData), string dataAssetId = default(string), string dataAssetReferenceId = default(string), string description = default(string))
        ...
        /// <summary>
        /// Gets the unique identifier of the data asset reference
        /// </summary>
