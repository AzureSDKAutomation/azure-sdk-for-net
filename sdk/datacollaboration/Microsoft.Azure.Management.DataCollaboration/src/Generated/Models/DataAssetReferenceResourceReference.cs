...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class DataAssetReferenceResourceReference : ResourceReference
    {
        ...
        /// reference</param>
        public DataAssetReferenceResourceReference(string resourceId = default(string), string resourceName = default(string), string resourceType = default(string), ResourceReferenceSystemData systemData = default(ResourceReferenceSystemData), string dataAssetId = default(string), string dataAssetReferenceId = default(string), string description = default(string))
