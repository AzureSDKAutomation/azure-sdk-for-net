...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class BlobDataSet : DataSet
    {
        ...
        /// resource</param>
        public BlobDataSet(string containerName, string filePath, string storageAccountId, string id = default(string), string name = default(string), ProxyDtoSystemData systemData = default(ProxyDtoSystemData), string type = default(string), string dataSetId = default(string))
