...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class SynapseSparkPool : ConstrainedResource
    {
        ...
        /// version.</param>
        public SynapseSparkPool(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), SynapseSparkPoolAutoPauseProperties autoPause = default(SynapseSparkPoolAutoPauseProperties), SynapseSparkPoolAutoScaleProperties autoScale = default(SynapseSparkPoolAutoScaleProperties), string constrainedResourceId = default(string), string family = default(string), int? nodeCount = default(int?), string nodeSize = default(string), string nodeSizeFamily = default(string), string provisioningState = default(string), string sparkVersion = default(string))
