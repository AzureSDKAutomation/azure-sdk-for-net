...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class Proposal : ProxyDto
    {
        ...
        public Proposal(string id = default(string), string name = default(string), ProxyDtoSystemData systemData = default(ProxyDtoSystemData), string type = default(string), string contractStatus = default(string), string currentVersion = default(string), System.DateTime? currentVersionTimestamp = default(System.DateTime?), string description = default(string), string displayName = default(string), string invitationId = default(string), string invitationLocation = default(string), string provisioningState = default(string), string terms = default(string))
