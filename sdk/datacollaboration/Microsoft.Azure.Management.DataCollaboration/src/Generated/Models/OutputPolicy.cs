...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class OutputPolicy : Policy
    {
        ...
        public OutputPolicy(string outputName, string id = default(string), string name = default(string), ProxyDtoSystemData systemData = default(ProxyDtoSystemData), string type = default(string), string appliesTo = default(string), string description = default(string))
