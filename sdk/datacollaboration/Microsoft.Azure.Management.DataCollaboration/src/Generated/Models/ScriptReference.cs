...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class ScriptReference : ProxyDto
    {
        ...
        public ScriptReference(int revision, string scriptId, string id = default(string), string name = default(string), ProxyDtoSystemData systemData = default(ProxyDtoSystemData), string type = default(string), string ownerId = default(string), string purpose = default(string), string scriptKind = default(string), string scriptReferenceId = default(string), string scriptVisibility = default(string), IList<string> sinks = default(IList<string>), IList<string> sources = default(IList<string>))
