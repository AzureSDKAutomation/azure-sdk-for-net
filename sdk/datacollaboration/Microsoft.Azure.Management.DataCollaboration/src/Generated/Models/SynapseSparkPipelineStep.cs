...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class SynapseSparkPipelineStep : PipelineStep
    {
        ...
        public SynapseSparkPipelineStep(string scriptId, int scriptRevision, IList<ScriptDataAssetBinding> scriptSinkBindings, IList<ScriptDataAssetBinding> scriptSourceBindings, string id = default(string), string name = default(string), ProxyDtoSystemData systemData = default(ProxyDtoSystemData), string type = default(string), IList<string> dependencies = default(IList<string>), string executorNodeSize = default(string), int? executorsCount = default(int?), string synapseSparkPoolId = default(string))
