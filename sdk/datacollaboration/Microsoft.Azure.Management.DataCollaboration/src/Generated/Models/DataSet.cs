...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class DataSet : ProxyDto
    {
        ...
        public DataSet(string id = default(string), string name = default(string), ProxyDtoSystemData systemData = default(ProxyDtoSystemData), string type = default(string))
