...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class ProxyDto : IResource
    {
        ...
        public ProxyDto(string id = default(string), string name = default(string), ProxyDtoSystemData systemData = default(ProxyDtoSystemData), string type = default(string))
        {
            Id = id;
            Name = name;
        ...
        public ProxyDtoSystemData SystemData { get; private set; }
