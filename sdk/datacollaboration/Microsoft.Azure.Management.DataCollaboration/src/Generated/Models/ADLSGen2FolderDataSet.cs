...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class ADLSGen2FolderDataSet : DataSet
    {
        /// <summary>
        /// Initializes a new instance of the ADLSGen2FolderDataSet class.
        /// </summary>
        ...
        /// resource</param>
        public ADLSGen2FolderDataSet(string fileSystem, string folderPath, string storageAccountId, string id = default(string), string name = default(string), ProxyDtoSystemData systemData = default(ProxyDtoSystemData), string type = default(string), string dataSetId = default(string))
