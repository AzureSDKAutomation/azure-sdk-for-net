...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    /// </summary>
    public partial class ProxyDtoSystemData : SystemData
    {
        /// <summary>
        /// Initializes a new instance of the ProxyDtoSystemData class.
        /// </summary>
        public ProxyDtoSystemData()
        {
            CustomInit();
        }
        ...
        public ProxyDtoSystemData(System.DateTime? createdAt = default(System.DateTime?), string createdBy = default(string), string createdByType = default(string), System.DateTime? lastModifiedAt = default(System.DateTime?), string lastModifiedBy = default(string), string lastModifiedByType = default(string))
