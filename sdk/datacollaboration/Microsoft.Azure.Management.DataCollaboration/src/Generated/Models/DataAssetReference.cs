...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class DataAssetReference : ProxyDto
    {
        ...
        /// owner</param>
        public DataAssetReference(string dataAssetId, string id = default(string), string name = default(string), ProxyDtoSystemData systemData = default(ProxyDtoSystemData), string type = default(string), string dataAssetReferenceId = default(string), string description = default(string), string ownerId = default(string))
