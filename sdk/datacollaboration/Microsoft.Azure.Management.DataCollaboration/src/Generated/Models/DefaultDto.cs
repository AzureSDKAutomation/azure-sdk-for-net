...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class DefaultDto : IResource
    {
        ...
        public DefaultDto(string id = default(string), string location = default(string), string name = default(string), DefaultDtoSystemData systemData = default(DefaultDtoSystemData), IDictionary<string, string> tags = default(IDictionary<string, string>), string type = default(string))
        {
            Id = id;
            Location = location;
            Name = name;
        ...
        public DefaultDtoSystemData SystemData { get; private set; }
