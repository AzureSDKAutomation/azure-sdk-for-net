...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class Pipeline : ProxyDto
    {
        ...
        public Pipeline(string id = default(string), string name = default(string), ProxyDtoSystemData systemData = default(ProxyDtoSystemData), string type = default(string), string description = default(string), string pipelineId = default(string), string provisioningState = default(string))
