...
namespace Microsoft.Azure.Management.DataCollaboration
{
    ...
    public static partial class ConstrainedResourcesOperationsExtensions
    {
            ...
            /// </param>
            public static ConstrainedResource CreateOrUpdate(this IConstrainedResourcesOperations operations, string resourceGroupName, string workspaceName, string constrainedResourceName, ConstrainedResource constrainedResource)
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, workspaceName, constrainedResourceName, constrainedResource).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ConstrainedResource> CreateOrUpdateAsync(this IConstrainedResourcesOperations operations, string resourceGroupName, string workspaceName, string constrainedResourceName, ConstrainedResource constrainedResource, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateOrUpdateWithHttpMessagesAsync(resourceGroupName, workspaceName, constrainedResourceName, constrainedResource, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The new constrained resource information.
            /// </param>
            public static ConstrainedResource BeginCreateOrUpdate(this IConstrainedResourcesOperations operations, string resourceGroupName, string workspaceName, string constrainedResourceName, ConstrainedResource constrainedResource)
            {
                return operations.BeginCreateOrUpdateAsync(resourceGroupName, workspaceName, constrainedResourceName, constrainedResource).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ConstrainedResource> BeginCreateOrUpdateAsync(this IConstrainedResourcesOperations operations, string resourceGroupName, string workspaceName, string constrainedResourceName, ConstrainedResource constrainedResource, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, workspaceName, constrainedResourceName, constrainedResource, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
