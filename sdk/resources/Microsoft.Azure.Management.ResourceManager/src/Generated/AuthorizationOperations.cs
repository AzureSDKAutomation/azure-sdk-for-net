...
namespace Microsoft.Azure.Management.ResourceManager
{
    ...
    /// </summary>
    internal partial class AuthorizationOperations : IServiceOperations<ManagementLockClient>, IAuthorizationOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal AuthorizationOperations(ManagementLockClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Authorization/operations").ToString();
