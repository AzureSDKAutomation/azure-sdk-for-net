...
namespace Microsoft.Azure.Management.ResourceManager
{
    ...
    public static partial class ResourcesOperationsExtensions
    {
            ...
            /// </param>
            public static ResourceCopyToken CopyResources(this IResourcesOperations operations, ResourceCopyInfo parameters, bool? validationOnly = default(bool?))
            {
                return operations.CopyResourcesAsync(parameters, validationOnly).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ResourceCopyToken> CopyResourcesAsync(this IResourcesOperations operations, ResourceCopyInfo parameters, bool? validationOnly = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CopyResourcesWithHttpMessagesAsync(parameters, validationOnly, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// Resource copy token.
            /// </param>
            public static ResourceCopyStatus ResourceCopyStatusMethod(this IResourcesOperations operations, string token)
            {
                return operations.ResourceCopyStatusMethodAsync(token).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ResourceCopyStatus> ResourceCopyStatusMethodAsync(this IResourcesOperations operations, string token, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ResourceCopyStatusMethodWithHttpMessagesAsync(token, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The operations group for this extension method.
            /// </param>
            public static IList<ResourceCopyStatus> ResourceCopiesStatus(this IResourcesOperations operations)
            {
                return operations.ResourceCopiesStatusAsync().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IList<ResourceCopyStatus>> ResourceCopiesStatusAsync(this IResourcesOperations operations, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ResourceCopiesStatusWithHttpMessagesAsync(null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// Resource copy token.
            /// </param>
            public static void FinalizeResourceCopy(this IResourcesOperations operations, string resourceGroupName, string providerName, string resourceType, string resourceName, string token)
            {
                operations.FinalizeResourceCopyAsync(resourceGroupName, providerName, resourceType, resourceName, token).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task FinalizeResourceCopyAsync(this IResourcesOperations operations, string resourceGroupName, string providerName, string resourceType, string resourceName, string token, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.FinalizeResourceCopyWithHttpMessagesAsync(resourceGroupName, providerName, resourceType, resourceName, token, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
