...
namespace Microsoft.Azure.Management.ResourceManager
{
    ...
    public partial interface IResourcesOperations
    {
        ...
        /// </summary>
        /// <remarks>
        /// The resources to be copied from one region to another. If
        /// validation is set to true, this operation validates resource copy
        /// from one region to another. When source resource group and target
        /// resource group are same, source ARM Id and target ARM Id cannot be
        /// same. The existingTarget represents the resource which already
        /// exists, and it will be used directly. Existing target resources may
        /// not be in the same RG with source resource, but they must exist in
        /// the target location.
        /// </remarks>
        /// <param name='parameters'>
        /// Parameters for moving resources.
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<ResourceCopyToken>> CopyResourcesWithHttpMessagesAsync(ResourceCopyInfo parameters, bool? validationOnly = default(bool?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets a single resource copy status under the given subscription and
        /// token.
        /// </summary>
        /// <remarks>
        /// This operation returns resource copy status under the given
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<ResourceCopyStatus>> ResourceCopyStatusMethodWithHttpMessagesAsync(string token, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<IList<ResourceCopyStatus>>> ResourceCopiesStatusWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse> FinalizeResourceCopyWithHttpMessagesAsync(string resourceGroupName, string providerName, string resourceType, string resourceName, string token, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<IPage<GenericResourceExpanded>>> ListWithHttpMessagesAsync(ODataQuery<GenericResourceFilter> odataQuery = default(ODataQuery<GenericResourceFilter>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<IPage<GenericResourceExpanded>>> ListByResourceGroupNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Get all the resources in a subscription.
        /// </summary>
        /// <param name='nextPageLink'>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<IPage<GenericResourceExpanded>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
