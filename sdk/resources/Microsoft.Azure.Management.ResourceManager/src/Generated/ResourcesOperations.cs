    ...
    internal partial class ResourcesOperations : IServiceOperations<ResourceManagementClient>, IResourcesOperations
    {
        ...
        public async Task<AzureOperationResponse> BeginMoveResourcesWithHttpMessagesAsync(string sourceResourceGroupName, ResourcesMoveInfo parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (sourceResourceGroupName != null)
            {
                ...
                if (!System.Text.RegularExpressions.Regex.IsMatch(sourceResourceGroupName, "^[-\\w\\._\\(\\)À-ÿ]+$"))
                {
                    throw new ValidationException(ValidationRules.Pattern, "sourceResourceGroupName", "^[-\\w\\._\\(\\)À-ÿ]+$");
                }
            }
            if (parameters == null)
            {
