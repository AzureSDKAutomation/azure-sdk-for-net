...
namespace Microsoft.Azure.Management.Cdn.Models
{
    ...
    public partial class RateLimitRule : CustomRule
    {
        ...
        public RateLimitRule(string name, int priority, IList<MatchCondition> matchConditions, ActionType action, int rateLimitThreshold, int rateLimitDurationInMinutes, string enabledState = default(string))
