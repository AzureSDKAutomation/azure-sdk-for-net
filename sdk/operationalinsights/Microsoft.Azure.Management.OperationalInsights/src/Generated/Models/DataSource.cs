...
namespace Microsoft.Azure.Management.OperationalInsights.Models
{
    ...
    public partial class DataSource : ProxyResource
    {
        ...
        public DataSource(IDictionary<string, object> properties, string kind, string id = default(string), string name = default(string), string type = default(string), string etag = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
            : base(id, name, type)
        {
