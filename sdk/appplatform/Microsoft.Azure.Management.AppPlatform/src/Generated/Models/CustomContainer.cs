...
namespace Microsoft.Azure.Management.AppPlatform.Models
{
    ...
    public partial class CustomContainer : UserSourceInfo
    {
        /// <summary>
        ...
        /// registry</param>
        public CustomContainer(string version = default(string), string server = default(string), string containerImage = default(string), IList<string> command = default(IList<string>), IList<string> args = default(IList<string>), ImageRegistryCredential imageRegistryCredential = default(ImageRegistryCredential))
            : base(version)
        {
            Server = server;
