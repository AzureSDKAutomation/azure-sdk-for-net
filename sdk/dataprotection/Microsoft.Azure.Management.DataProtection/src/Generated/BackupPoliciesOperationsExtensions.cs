...
namespace Microsoft.Azure.Management.DataProtection
{
    ...
    public static partial class BackupPoliciesOperationsExtensions
    {
            ...
            /// </param>
            public static BaseBackupPolicyResource Put(this IBackupPoliciesOperations operations, string vaultName, string resourceGroupName, string backupPolicyName, IList<string> datasourceTypes)
            {
                return operations.PutAsync(vaultName, resourceGroupName, backupPolicyName, datasourceTypes).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BaseBackupPolicyResource> PutAsync(this IBackupPoliciesOperations operations, string vaultName, string resourceGroupName, string backupPolicyName, IList<string> datasourceTypes, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.PutWithHttpMessagesAsync(vaultName, resourceGroupName, backupPolicyName, datasourceTypes, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
