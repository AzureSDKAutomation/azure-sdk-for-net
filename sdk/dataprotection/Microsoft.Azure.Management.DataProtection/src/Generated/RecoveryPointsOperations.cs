...
namespace Microsoft.Azure.Management.DataProtection
{
    ...
    internal partial class RecoveryPointsOperations : IServiceOperations<DataProtectionClient>, IRecoveryPointsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<AzureBackupRecoveryPointResource>>> GetListWithHttpMessagesAsync(string vaultName, string resourceGroupName, string backupInstanceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (vaultName == null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<AzureBackupRecoveryPointResource>>> GetListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "GetListNext", tracingParameters);
            }
            // Construct URL
