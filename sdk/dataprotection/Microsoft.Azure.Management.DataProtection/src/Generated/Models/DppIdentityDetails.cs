...
namespace Microsoft.Azure.Management.DataProtection.Models
{
    ...
    public partial class DppIdentityDetails
    {
        ...
        /// Initializes a new instance of the DppIdentityDetails class.
        /// </summary>
        /// <param name="identityUrl">Identity Url</param>
        ...
        public DppIdentityDetails(string identityUrl = default(string), string principalId = default(string), string tenantId = default(string), string type = default(string))
        {
