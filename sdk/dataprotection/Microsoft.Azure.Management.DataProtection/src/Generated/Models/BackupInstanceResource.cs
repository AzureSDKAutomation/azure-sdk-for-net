...
namespace Microsoft.Azure.Management.DataProtection.Models
{
    ...
    public partial class BackupInstanceResource : DppResource
    {
        ...
        public BackupInstanceResource(Datasource dataSourceInfo, PolicyInfo policyInfo, string id = default(string), string name = default(string), string type = default(string), DatasourceSet dataSourceSetInfo = default(DatasourceSet), string objectType = default(string), ProtectionStatusDetails protectionStatus = default(ProtectionStatusDetails), string provisioningState = default(string))
            : base(id, name, type)
        {
