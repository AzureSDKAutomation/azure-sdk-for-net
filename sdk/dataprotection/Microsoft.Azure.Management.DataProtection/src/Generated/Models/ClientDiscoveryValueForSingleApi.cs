...
namespace Microsoft.Azure.Management.DataProtection.Models
{
    ...
    public partial class ClientDiscoveryValueForSingleApi
    {
        ...
        public ClientDiscoveryValueForSingleApi(ClientDiscoveryDisplay display = default(ClientDiscoveryDisplay), string name = default(string), string origin = default(string), ClientDiscoveryForServiceSpecification serviceSpecification = default(ClientDiscoveryForServiceSpecification))
        {
            Display = display;
            Name = name;
            Origin = origin;
