...
namespace Microsoft.Azure.Management.DataProtection.Models
{
    ...
    public partial class UserFacingError
    {
        ...
        public UserFacingError(string code = default(string), IList<UserFacingError> details = default(IList<UserFacingError>), InnerError innerError = default(InnerError), bool? isRetryable = default(bool?), bool? isUserError = default(bool?), string message = default(string), IList<string> recommendedAction = default(IList<string>), string target = default(string))
        {
            Code = code;
            Details = details;
        ...
        /// <summary>
        /// Gets or sets recommendedAction � Localised.
        /// </summary>
