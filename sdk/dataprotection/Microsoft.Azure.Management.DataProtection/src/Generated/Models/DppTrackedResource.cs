...
namespace Microsoft.Azure.Management.DataProtection.Models
{
    ...
    public partial class DppTrackedResource : IResource
    {
        ...
        public DppTrackedResource(string eTag = default(string), string id = default(string), DppIdentityDetails identity = default(DppIdentityDetails), string location = default(string), string name = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string type = default(string))
        {
            ETag = eTag;
            Id = id;
            Identity = identity;
