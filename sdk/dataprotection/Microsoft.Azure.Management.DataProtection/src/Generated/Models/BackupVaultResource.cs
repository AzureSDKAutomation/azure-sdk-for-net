...
namespace Microsoft.Azure.Management.DataProtection.Models
{
    ...
    public partial class BackupVaultResource : DppTrackedResource
    {
        ...
        public BackupVaultResource(string eTag = default(string), string id = default(string), DppIdentityDetails identity = default(DppIdentityDetails), string location = default(string), string name = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string type = default(string), string provisioningState = default(string), IList<StorageSetting> storageSettings = default(IList<StorageSetting>))
