...
namespace Microsoft.Azure.ContainerRegistry
{
    ...
    internal partial class AccessTokensOperations : IServiceOperations<AzureContainerRegistryClient>, IAccessTokensOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<AccessToken>> GetWithHttpMessagesAsync(string grantType, string service, string scope, string refreshToken, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
