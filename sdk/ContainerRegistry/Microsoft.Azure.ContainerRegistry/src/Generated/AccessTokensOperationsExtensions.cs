...
namespace Microsoft.Azure.ContainerRegistry
{
    ...
    public static partial class AccessTokensOperationsExtensions
    {
            ...
            /// Grant type is expected to be refresh_token. Possible values include:
            ...
            /// </param>
            public static async Task<AccessToken> GetAsync(this IAccessTokensOperations operations, string grantType, string service, string scope, string refreshToken, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetWithHttpMessagesAsync(grantType, service, scope, refreshToken, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
