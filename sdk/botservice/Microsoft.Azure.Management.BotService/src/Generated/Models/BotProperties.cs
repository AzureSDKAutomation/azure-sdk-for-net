...
namespace Microsoft.Azure.Management.BotService.Models
{
    ...
    public partial class BotProperties
    {
        ...
        public BotProperties(string displayName, string endpoint, string msaAppId, string description = default(string), string iconUrl = default(string), string endpointVersion = default(string), IList<string> configuredChannels = default(IList<string>), IList<string> enabledChannels = default(IList<string>), string developerAppInsightKey = default(string), string developerAppInsightsApiKey = default(string), string developerAppInsightsApplicationId = default(string), IList<string> luisAppIds = default(IList<string>), string luisKey = default(string), bool? isCmekEnabled = default(bool?), string cmekKeyVaultUrl = default(string), bool? isIsolated = default(bool?), bool? disableLocalAuth = default(bool?), string schemaTransformationVersion = default(string))
        {
