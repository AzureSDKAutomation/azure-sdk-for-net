...
namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class ServiceTagsOperations : IServiceOperations<NetworkManagementClient>, IServiceTagsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<ServiceTagInformation>>> ListWithHttpMessagesAsync(string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
