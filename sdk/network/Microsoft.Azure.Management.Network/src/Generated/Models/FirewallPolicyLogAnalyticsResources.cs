...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class FirewallPolicyLogAnalyticsResources
    {
        ...
        /// FirewallPolicyLogAnalyticsResources class.
        /// </summary>
        /// <param name="workspaceIds">List of workspace Ids for Firewall
        /// Policy Insights</param>
        /// <param name="defaultWorkspaceId">The default workspace Id for
        /// Firewall Policy Insights</param>
        public FirewallPolicyLogAnalyticsResources(IList<SubResource> workspaceIds = default(IList<SubResource>), SubResource defaultWorkspaceId = default(SubResource))
        {
        ...
        /// <summary>
        /// Gets or sets list of workspace Ids for Firewall Policy Insights
        /// </summary>
        [JsonProperty(PropertyName = "workspaceIds")]
        public IList<SubResource> WorkspaceIds { get; set; }
