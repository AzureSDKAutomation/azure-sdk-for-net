...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class NetworkManagerCommit
    {
        ...
        /// 'AdminPolicy', 'UserPolicy', 'Routing', 'Connectivity'</param>
        public NetworkManagerCommit(IList<string> targetLocations = default(IList<string>), IList<string> configurationIds = default(IList<string>), string commitType = default(string))
        {
