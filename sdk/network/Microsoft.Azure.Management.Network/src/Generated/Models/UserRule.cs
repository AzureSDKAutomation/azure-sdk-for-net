...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class UserRule : ProxyResource
    {
        /// <summary>
        ...
        /// resource.</param>
        public UserRule(string protocol, string direction, string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string displayName = default(string), string description = default(string), IList<AddressPrefixItem> source = default(IList<AddressPrefixItem>), IList<AddressPrefixItem> destination = default(IList<AddressPrefixItem>), IList<string> sourcePortRanges = default(IList<string>), IList<string> destinationPortRanges = default(IList<string>), string provisioningState = default(string), SystemData systemData = default(SystemData))
