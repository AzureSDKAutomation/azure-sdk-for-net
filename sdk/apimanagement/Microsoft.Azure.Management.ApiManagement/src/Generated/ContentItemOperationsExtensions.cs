...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    public static partial class ContentItemOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<ContentItemContract> ListByService(this IContentItemOperations operations, string resourceGroupName, string serviceName, string contentTypeId, string filter = default(string), string orderby = default(string))
            {
                return operations.ListByServiceAsync(resourceGroupName, serviceName, contentTypeId, filter, orderby).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<IPage<ContentItemContract>> ListByServiceAsync(this IContentItemOperations operations, string resourceGroupName, string serviceName, string contentTypeId, string filter = default(string), string orderby = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListByServiceWithHttpMessagesAsync(resourceGroupName, serviceName, contentTypeId, filter, orderby, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
