...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    public partial interface IContentItemOperations
    {
        ...
        /// </param>
        /// <param name='filter'>
        /// Filters the results based on the provided query. Supported
        /// functions: `contains`, `startswith`, `endswith`, `eq`. Supported
        /// fields: any field from the properties object. For example,
        /// `$filter=contains(title,'test')`.
        /// </param>
        /// <param name='orderby'>
        /// Sorts the results by the provided property. Supported options:
        /// `asc`, `desc`. Supported fields: any field from the properties
        /// object. For example, `$orderby=en_us/title desc`.
        /// </param>
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<ContentItemContract>>> ListByServiceWithHttpMessagesAsync(string resourceGroupName, string serviceName, string contentTypeId, string filter = default(string), string orderby = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
