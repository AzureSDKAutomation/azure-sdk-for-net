...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// </summary>
    public partial class EventGridFilterGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EventGridFilterGetHeaders class.
        /// </summary>
        public EventGridFilterGetHeaders()
        {
            CustomInit();
        }
        ...
        public EventGridFilterGetHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
