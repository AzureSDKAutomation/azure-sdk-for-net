...
namespace Microsoft.Azure.Management.ApplicationInsights.Management.Models
{
    ...
    public partial class WebTestPropertiesValidationRulesContentValidation
    {
        ...
        /// WebTest.  Must not be null or empty.</param>
        ...
        public WebTestPropertiesValidationRulesContentValidation(string contentMatch = default(string), bool? ignoreCase = default(bool?), bool? passIfTextFound = default(bool?))
        {
