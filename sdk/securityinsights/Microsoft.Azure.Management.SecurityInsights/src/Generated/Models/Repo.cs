...
namespace Microsoft.Azure.Management.SecurityInsights.Models
{
    ...
    public partial class Repo
    {
        ...
        /// Initializes a new instance of the Repo class.
        /// </summary>
        /// <param name="repoUrl">The url to access the repository.</param>
        /// <param name="fullName">The name of the repository.</param>
        /// <param name="branches">Array of branches.</param>
        public Repo(string repoUrl = default(string), string fullName = default(string), IList<string> branches = default(IList<string>))
        {
            RepoUrl = repoUrl;
            FullName = fullName;
            Branches = branches;
