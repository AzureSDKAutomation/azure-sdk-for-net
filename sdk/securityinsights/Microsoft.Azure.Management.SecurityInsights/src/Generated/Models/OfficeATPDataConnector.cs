...
namespace Microsoft.Azure.Management.SecurityInsights.Models
{
    ...
    /// connector.
    /// </summary>
    [Newtonsoft.Json.JsonObject("OfficeATP")]
    [Rest.Serialization.JsonTransformation]
    public partial class OfficeATPDataConnector : DataConnector
    {
        /// <summary>
        /// Initializes a new instance of the OfficeATPDataConnector class.
        /// </summary>
        ...
        /// connector.</param>
        public OfficeATPDataConnector(string tenantId, string id = default(string), string name = default(string), string type = default(string), string etag = default(string), SystemData systemData = default(SystemData), AlertsDataTypeOfDataConnector dataTypes = default(AlertsDataTypeOfDataConnector))
