...
namespace Microsoft.Azure.Management.SecurityInsights.Models
{
    ...
    public partial class SourceControl : ResourceWithEtag
    {
        ...
        /// control</param>
        public SourceControl(string displayName, string repoType, IList<string> contentTypes, Repository repository, string id = default(string), string name = default(string), string type = default(string), string etag = default(string), SystemData systemData = default(SystemData), string sourceControlId = default(string), string description = default(string))
