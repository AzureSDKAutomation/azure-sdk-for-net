...
namespace Microsoft.Azure.Management.SecurityInsights.Models
{
    ...
    public partial class MSTIDataConnector : DataConnector
    {
        /// <summary>
        /// Initializes a new instance of the MSTIDataConnector class.
        /// </summary>
        ...
        public MSTIDataConnector(string tenantId, MSTIDataConnectorDataTypes dataTypes, string id = default(string), string name = default(string), string type = default(string), string etag = default(string), SystemData systemData = default(SystemData))
        ...
        public MSTIDataConnectorDataTypes DataTypes { get; set; }
