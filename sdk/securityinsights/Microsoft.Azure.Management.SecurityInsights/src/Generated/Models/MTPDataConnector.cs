...
namespace Microsoft.Azure.Management.SecurityInsights.Models
{
    ...
    public partial class MTPDataConnector : DataConnector
    {
        ...
        public MTPDataConnector(string tenantId, MTPDataConnectorDataTypes dataTypes, string id = default(string), string name = default(string), string type = default(string), string etag = default(string), SystemData systemData = default(SystemData))
