...
namespace Microsoft.Azure.Management.SecurityInsights.Models
{
    ...
    public partial class MetadataModel : ResourceWithEtag
    {
        /// <summary>
        ...
        public MetadataModel(string contentId, string parentId, string kind, string id = default(string), string name = default(string), string type = default(string), string etag = default(string), SystemData systemData = default(SystemData), string version = default(string), MetadataSource source = default(MetadataSource), MetadataAuthor author = default(MetadataAuthor), MetadataSupport support = default(MetadataSupport), MetadataDependencies dependencies = default(MetadataDependencies))
