...
namespace Microsoft.Azure.Management.SecurityInsights.Models
{
    ...
    public partial class AATPDataConnector : DataConnector
    {
        ...
        /// connector.</param>
        public AATPDataConnector(string tenantId, string id = default(string), string name = default(string), string type = default(string), string etag = default(string), SystemData systemData = default(SystemData), AlertsDataTypeOfDataConnector dataTypes = default(AlertsDataTypeOfDataConnector))
