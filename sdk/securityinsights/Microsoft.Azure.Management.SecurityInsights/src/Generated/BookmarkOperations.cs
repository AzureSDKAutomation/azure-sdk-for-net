...
namespace Microsoft.Azure.Management.SecurityInsights
{
    ...
    /// </summary>
    internal partial class BookmarkOperations : IServiceOperations<SecurityInsightsClient>, IBookmarkOperations
    {
        /// <summary>
        /// Initializes a new instance of the BookmarkOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal BookmarkOperations(SecurityInsightsClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<BookmarkExpandResponse>> ExpandWithHttpMessagesAsync(string resourceGroupName, string operationalInsightsResourceProvider, string workspaceName, string bookmarkId, BookmarkExpandParameters parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("bookmarkId", bookmarkId);
                tracingParameters.Add("parameters", parameters);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "Expand", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{operationalInsightsResourceProvider}/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/bookmarks/{bookmarkId}/expand").ToString();
            ...
            _url = _url.Replace("{bookmarkId}", System.Uri.EscapeDataString(bookmarkId));
            ...
            // Create Result
            var _result = new AzureOperationResponse<BookmarkExpandResponse>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<BookmarkExpandResponse>(_responseContent, Client.DeserializationSettings);
                }
