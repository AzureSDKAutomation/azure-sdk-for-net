...
namespace Microsoft.Azure.Management.SecurityInsights
{
    ...
    public static partial class IncidentCommentsOperationsExtensions
    {
            ...
            /// </param>
            public static IncidentComment CreateOrUpdateComment(this IIncidentCommentsOperations operations, string resourceGroupName, string workspaceName, string incidentId, string incidentCommentId, string message, string etag = default(string))
            {
                return operations.CreateOrUpdateCommentAsync(resourceGroupName, workspaceName, incidentId, incidentCommentId, message, etag).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IncidentComment> CreateOrUpdateCommentAsync(this IIncidentCommentsOperations operations, string resourceGroupName, string workspaceName, string incidentId, string incidentCommentId, string message, string etag = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateOrUpdateCommentWithHttpMessagesAsync(resourceGroupName, workspaceName, incidentId, incidentCommentId, message, etag, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
