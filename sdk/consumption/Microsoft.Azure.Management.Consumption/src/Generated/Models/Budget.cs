...
namespace Microsoft.Azure.Management.Consumption.Models
{
    ...
    public partial class Budget : ProxyResource
    {
        ...
        public Budget(decimal amount, string timeGrain, BudgetTimePeriod timePeriod, string id = default(string), string name = default(string), string type = default(string), BudgetFilter filter = default(BudgetFilter), CurrentSpend currentSpend = default(CurrentSpend), IDictionary<string, Notification> notifications = default(IDictionary<string, Notification>))
            : base(id, name, type)
        {
            Amount = amount;
            TimeGrain = timeGrain;
