...
namespace Microsoft.Azure.Management.Consumption.Models
{
    ...
    public partial class CreditSummary : Resource
    {
        ...
        /// charges.</param>
        public CreditSummary(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), CreditBalanceSummary balanceSummary = default(CreditBalanceSummary), Amount pendingCreditAdjustments = default(Amount), Amount expiredCredit = default(Amount), Amount pendingEligibleCharges = default(Amount))
