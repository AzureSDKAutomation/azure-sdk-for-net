...
namespace Microsoft.Azure.Management.Subscription
{
    ...
    public static partial class SubscriptionOperationOperationsExtensions
    {
            ...
            /// generate recommendation response header.
            /// </param>
            public static SubscriptionCreationResult BeginGet(this ISubscriptionOperationOperations operations, string operationId)
            {
                return operations.BeginGetAsync(operationId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SubscriptionCreationResult> BeginGetAsync(this ISubscriptionOperationOperations operations, string operationId, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginGetWithHttpMessagesAsync(operationId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
