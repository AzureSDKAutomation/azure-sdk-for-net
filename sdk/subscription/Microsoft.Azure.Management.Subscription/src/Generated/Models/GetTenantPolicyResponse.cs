...
namespace Microsoft.Azure.Management.Subscription.Models
{
    ...
    public partial class GetTenantPolicyResponse : IResource
    {
        ...
        public GetTenantPolicyResponse(string id = default(string), string name = default(string), string type = default(string), TenantPolicy properties = default(TenantPolicy))
        {
            Id = id;
            Name = name;
            Type = type;
