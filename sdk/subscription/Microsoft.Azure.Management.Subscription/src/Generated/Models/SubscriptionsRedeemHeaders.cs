...
namespace Microsoft.Azure.Management.Subscription.Models
{
    ...
    /// </summary>
    public partial class SubscriptionsRedeemHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SubscriptionsRedeemHeaders class.
        /// </summary>
        public SubscriptionsRedeemHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public SubscriptionsRedeemHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
