...
namespace Microsoft.Azure.Management.Subscription.Models
{
    ...
    /// </summary>
    public partial class SubscriptionsCreateSubscriptionInEnrollmentAccountHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// SubscriptionsCreateSubscriptionInEnrollmentAccountHeaders class.
        /// </summary>
        public SubscriptionsCreateSubscriptionInEnrollmentAccountHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public SubscriptionsCreateSubscriptionInEnrollmentAccountHeaders(string location = default(string), string retryAfter = default(string))
        {
            Location = location;
