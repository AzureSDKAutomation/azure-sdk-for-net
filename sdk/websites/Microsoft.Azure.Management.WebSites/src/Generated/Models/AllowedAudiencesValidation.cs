...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class AllowedAudiencesValidation : ProxyOnlyResource
    {
        ...
        public AllowedAudiencesValidation(string id = default(string), string name = default(string), string kind = default(string), string type = default(string), SystemData systemData = default(SystemData), IList<string> allowedAudiences = default(IList<string>))
