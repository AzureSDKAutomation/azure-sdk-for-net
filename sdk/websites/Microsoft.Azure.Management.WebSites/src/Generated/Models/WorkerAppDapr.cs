...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    /// <summary>
    /// Worker App Dapr configuration.
    /// </summary>
    public partial class WorkerAppDapr
    {
        /// <summary>
        /// Initializes a new instance of the WorkerAppDapr class.
        /// </summary>
        public WorkerAppDapr()
        {
            CustomInit();
        }
        ...
        public WorkerAppDapr(bool? enabled = default(bool?), string appId = default(string), int? appPort = default(int?), IList<WorkerAppDaprComponent> components = default(IList<WorkerAppDaprComponent>))
        {
            Enabled = enabled;
            AppId = appId;
            AppPort = appPort;
        ...
        public IList<WorkerAppDaprComponent> Components { get; set; }
