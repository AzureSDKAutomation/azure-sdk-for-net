...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    /// </summary>
    public partial class WorkerAppCustomScaleRule
    {
        /// <summary>
        /// Initializes a new instance of the WorkerAppCustomScaleRule class.
        /// </summary>
        public WorkerAppCustomScaleRule()
        {
            CustomInit();
        }
        ...
        /// rule.</param>
        public WorkerAppCustomScaleRule(string type = default(string), IDictionary<string, string> metadata = default(IDictionary<string, string>), IList<WorkerAppScaleRuleAuth> auth = default(IList<WorkerAppScaleRuleAuth>))
        {
            Type = type;
            Metadata = metadata;
            Auth = auth;
