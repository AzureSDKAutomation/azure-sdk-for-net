...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class ConnectionStringDictionary : ProxyOnlyResource
    {
        ...
        public ConnectionStringDictionary(string id = default(string), string name = default(string), string kind = default(string), string type = default(string), SystemData systemData = default(SystemData), IDictionary<string, ConnStringValueTypePair> properties = default(IDictionary<string, ConnStringValueTypePair>))
