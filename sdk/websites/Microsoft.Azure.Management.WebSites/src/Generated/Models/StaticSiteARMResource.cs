...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class StaticSiteARMResource : Resource
    {
        ...
        public StaticSiteARMResource(string location, string id = default(string), string name = default(string), string kind = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string defaultHostname = default(string), string repositoryUrl = default(string), string branch = default(string), string provider = default(string), IList<string> customDomains = default(IList<string>), string repositoryToken = default(string), StaticSiteBuildProperties buildProperties = default(StaticSiteBuildProperties), StaticSiteTemplateOptions templateProperties = default(StaticSiteTemplateOptions), IList<ResponseMessageEnvelopeRemotePrivateEndpointConnection> privateEndpointConnections = default(IList<ResponseMessageEnvelopeRemotePrivateEndpointConnection>), string contentDistributionEndpoint = default(string), string keyVaultReferenceIdentity = default(string), IList<StaticSiteUserProvidedFunctionApp> userProvidedFunctionApps = default(IList<StaticSiteUserProvidedFunctionApp>), StagingEnvironmentPolicy? stagingEnvironmentPolicy = default(StagingEnvironmentPolicy?), bool? allowConfigFileUpdates = default(bool?), SkuDescription sku = default(SkuDescription), ManagedServiceIdentity identity = default(ManagedServiceIdentity))
