...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class RemotePrivateEndpointConnection
    {
        ...
        public RemotePrivateEndpointConnection(string provisioningState = default(string), ArmIdWrapper privateEndpoint = default(ArmIdWrapper), PrivateLinkConnectionState privateLinkServiceConnectionState = default(PrivateLinkConnectionState), IList<string> ipAddresses = default(IList<string>))
        {
