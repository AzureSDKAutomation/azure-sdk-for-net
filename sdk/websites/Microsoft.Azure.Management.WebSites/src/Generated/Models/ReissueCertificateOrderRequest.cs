...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class ReissueCertificateOrderRequest : ProxyOnlyResource
    {
        ...
        /// versa).</param>
        public ReissueCertificateOrderRequest(string id = default(string), string name = default(string), string kind = default(string), string type = default(string), SystemData systemData = default(SystemData), int? keySize = default(int?), int? delayExistingRevokeInHours = default(int?), string csr = default(string), bool? isPrivateKeyExternal = default(bool?))
