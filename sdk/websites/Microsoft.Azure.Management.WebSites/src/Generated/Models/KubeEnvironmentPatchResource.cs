...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class KubeEnvironmentPatchResource : ProxyOnlyResource
    {
        ...
        /// supported</param>
        public KubeEnvironmentPatchResource(string id = default(string), string name = default(string), string kind = default(string), string type = default(string), ExtendedLocation extendedLocation = default(ExtendedLocation), KubeEnvironmentProvisioningState? provisioningState = default(KubeEnvironmentProvisioningState?), string deploymentErrors = default(string), bool? internalLoadBalancerEnabled = default(bool?), string defaultDomain = default(string), string staticIp = default(string), ArcConfiguration arcConfiguration = default(ArcConfiguration), AppLogsConfiguration appLogsConfiguration = default(AppLogsConfiguration), string aksResourceID = default(string))
