...
namespace Microsoft.Azure.Management.WebSites
{
    ...
    public static partial class KubeEnvironmentsOperationsExtensions
    {
            ...
            /// ID of the operation.
            /// </param>
            public static object GetOperation(this IKubeEnvironmentsOperations operations, string resourceGroupName, string name, string operationId)
            {
                return operations.GetOperationAsync(resourceGroupName, name, operationId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> GetOperationAsync(this IKubeEnvironmentsOperations operations, string resourceGroupName, string name, string operationId, CancellationToken cancellationToken = default(CancellationToken))
            {
