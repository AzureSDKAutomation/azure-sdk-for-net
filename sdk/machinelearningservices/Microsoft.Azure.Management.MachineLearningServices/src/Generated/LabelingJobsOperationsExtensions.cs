...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    public static partial class LabelingJobsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<LabelingJobResource> List(this ILabelingJobsOperations operations, string resourceGroupName, string workspaceName, string skiptoken = default(string), int? count = default(int?))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<LabelingJobResource>> ListAsync(this ILabelingJobsOperations operations, string resourceGroupName, string workspaceName, string skiptoken = default(string), int? count = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
