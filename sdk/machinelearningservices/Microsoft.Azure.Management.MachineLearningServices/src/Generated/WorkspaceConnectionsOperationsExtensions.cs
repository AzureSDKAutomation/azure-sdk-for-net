...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    public static partial class WorkspaceConnectionsOperationsExtensions
    {
            ...
            /// </param>
            public static WorkspaceConnection Create(this IWorkspaceConnectionsOperations operations, string resourceGroupName, string workspaceName, string connectionName, WorkspaceConnection parameters)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<WorkspaceConnection> CreateAsync(this IWorkspaceConnectionsOperations operations, string resourceGroupName, string workspaceName, string connectionName, WorkspaceConnection parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
