...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    public static partial class ComputeOperationsExtensions
    {
            ...
            /// Name of the Azure Machine Learning compute.
            /// </param>
            public static void BeginRestart(this IComputeOperations operations, string resourceGroupName, string workspaceName, string computeName)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginRestartAsync(this IComputeOperations operations, string resourceGroupName, string workspaceName, string computeName, CancellationToken cancellationToken = default(CancellationToken))
            {
