...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    public static partial class JobsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<JobBaseResource> List(this IJobsOperations operations, string resourceGroupName, string workspaceName, string skiptoken = default(string), string jobType = default(string), string tags = default(string), string tag = default(string))
            {
                return operations.ListAsync(resourceGroupName, workspaceName, skiptoken, jobType, tags, tag).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<JobBaseResource>> ListAsync(this IJobsOperations operations, string resourceGroupName, string workspaceName, string skiptoken = default(string), string jobType = default(string), string tags = default(string), string tag = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListWithHttpMessagesAsync(resourceGroupName, workspaceName, skiptoken, jobType, tags, tag, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
