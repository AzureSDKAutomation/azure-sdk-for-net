...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    public static partial class OnlineEndpointsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<OnlineEndpointTrackedResource> List(this IOnlineEndpointsOperations operations, string resourceGroupName, string workspaceName, string name = default(string), int? count = default(int?), string computeType = default(string), string skiptoken = default(string), string tags = default(string), string properties = default(string), string orderBy = default(string))
            {
                return operations.ListAsync(resourceGroupName, workspaceName, name, count, computeType, skiptoken, tags, properties, orderBy).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<IPage<OnlineEndpointTrackedResource>> ListAsync(this IOnlineEndpointsOperations operations, string resourceGroupName, string workspaceName, string name = default(string), int? count = default(int?), string computeType = default(string), string skiptoken = default(string), string tags = default(string), string properties = default(string), string orderBy = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListWithHttpMessagesAsync(resourceGroupName, workspaceName, name, count, computeType, skiptoken, tags, properties, orderBy, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
