...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    public static partial class MachineLearningComputeOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<ComputeResource> ListByWorkspace(this IMachineLearningComputeOperations operations, string resourceGroupName, string workspaceName, string skip = default(string))
            {
                return operations.ListByWorkspaceAsync(resourceGroupName, workspaceName, skip).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<IPage<ComputeResource>> ListByWorkspaceAsync(this IMachineLearningComputeOperations operations, string resourceGroupName, string workspaceName, string skip = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListByWorkspaceWithHttpMessagesAsync(resourceGroupName, workspaceName, skip, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// Name of the Azure Machine Learning compute.
            /// </param>
            public static IPage<AmlComputeNodeInformation> ListNodes(this IMachineLearningComputeOperations operations, string resourceGroupName, string workspaceName, string computeName)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<AmlComputeNodeInformation>> ListNodesAsync(this IMachineLearningComputeOperations operations, string resourceGroupName, string workspaceName, string computeName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Name of the Azure Machine Learning compute.
            /// </param>
            public static void BeginStart(this IMachineLearningComputeOperations operations, string resourceGroupName, string workspaceName, string computeName)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginStartAsync(this IMachineLearningComputeOperations operations, string resourceGroupName, string workspaceName, string computeName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Name of the Azure Machine Learning compute.
            /// </param>
            public static void BeginStop(this IMachineLearningComputeOperations operations, string resourceGroupName, string workspaceName, string computeName)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginStopAsync(this IMachineLearningComputeOperations operations, string resourceGroupName, string workspaceName, string computeName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Name of the Azure Machine Learning compute.
            /// </param>
            public static void BeginRestart(this IMachineLearningComputeOperations operations, string resourceGroupName, string workspaceName, string computeName)
            {
                operations.BeginRestartAsync(resourceGroupName, workspaceName, computeName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginRestartAsync(this IMachineLearningComputeOperations operations, string resourceGroupName, string workspaceName, string computeName, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.BeginRestartWithHttpMessagesAsync(resourceGroupName, workspaceName, computeName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            /// The NextLink from the previous successful call to List operation.
            /// </param>
            public static IPage<AmlComputeNodeInformation> ListNodesNext(this IMachineLearningComputeOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<AmlComputeNodeInformation>> ListNodesNextAsync(this IMachineLearningComputeOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
