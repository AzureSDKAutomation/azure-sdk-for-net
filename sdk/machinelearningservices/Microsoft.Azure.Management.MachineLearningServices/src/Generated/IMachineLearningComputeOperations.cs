...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    public partial interface IMachineLearningComputeOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<ComputeResource>>> ListByWorkspaceWithHttpMessagesAsync(string resourceGroupName, string workspaceName, string skip = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
