...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class CodeContainerResource : IResource
    {
        /// <summary>
        ...
        /// provider</param>
        public CodeContainerResource(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> properties = default(IDictionary<string, string>), IDictionary<string, string> tags = default(IDictionary<string, string>), string description = default(string), SystemData systemData = default(SystemData))
        {
            Id = id;
            Name = name;
            Type = type;
