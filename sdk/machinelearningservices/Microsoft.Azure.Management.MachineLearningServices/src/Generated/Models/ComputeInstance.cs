...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ComputeInstance class.
        /// </summary>
        ...
        public ComputeInstance(string computeLocation = default(string), string provisioningState = default(string), string description = default(string), string resourceId = default(string), IList<MachineLearningServiceError> provisioningErrors = default(IList<MachineLearningServiceError>), bool? isAttachedCompute = default(bool?), ComputeInstanceProperties properties = default(ComputeInstanceProperties))
            : base(computeLocation, provisioningState, description, resourceId, provisioningErrors, isAttachedCompute)
        {
        ...
        /// <summary>
        /// Gets or sets compute Instance properties
        /// </summary>
