...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    /// </summary>
    public partial class OnlineEndpointsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the OnlineEndpointsUpdateHeaders
        /// class.
        /// </summary>
        public OnlineEndpointsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        public OnlineEndpointsUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
