...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class CodeVersionResource : IResource
    {
        /// <summary>
        ...
        /// provider</param>
        public CodeVersionResource(string id = default(string), string name = default(string), string type = default(string), string datastoreId = default(string), AssetPath assetPath = default(AssetPath), string path = default(string), string generatedBy = default(string), string description = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), IDictionary<string, string> properties = default(IDictionary<string, string>), SystemData systemData = default(SystemData))
        {
            Id = id;
            Name = name;
            Type = type;
