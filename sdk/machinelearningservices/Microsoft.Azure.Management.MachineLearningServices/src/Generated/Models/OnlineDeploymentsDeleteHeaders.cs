...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    /// </summary>
    public partial class OnlineDeploymentsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the OnlineDeploymentsDeleteHeaders
        /// class.
        /// </summary>
        public OnlineDeploymentsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        public OnlineDeploymentsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
