...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    /// </summary>
    public partial class JobsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the JobsDeleteHeaders class.
        /// </summary>
        public JobsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        public JobsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
