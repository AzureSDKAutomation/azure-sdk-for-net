...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class ComponentContainerResource : IResource
    {
        /// <summary>
        /// Initializes a new instance of the ComponentContainerResource class.
        /// </summary>
        public ComponentContainerResource()
        {
            CustomInit();
        }
        ...
        /// provider</param>
        public ComponentContainerResource(string id = default(string), string name = default(string), string type = default(string), string description = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), IDictionary<string, string> properties = default(IDictionary<string, string>), SystemData systemData = default(SystemData))
        {
            Id = id;
            Name = name;
            Type = type;
