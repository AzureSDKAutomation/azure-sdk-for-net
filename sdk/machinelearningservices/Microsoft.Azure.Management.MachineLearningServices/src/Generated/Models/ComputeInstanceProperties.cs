...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class ComputeInstanceProperties
    {
        ...
        public ComputeInstanceProperties(string vmSize = default(string), ResourceId subnet = default(ResourceId), string applicationSharingPolicy = default(string), ComputeInstanceSshSettings sshSettings = default(ComputeInstanceSshSettings), ComputeInstanceConnectivityEndpoints connectivityEndpoints = default(ComputeInstanceConnectivityEndpoints), IList<ComputeInstanceApplication> applications = default(IList<ComputeInstanceApplication>), ComputeInstanceCreatedBy createdBy = default(ComputeInstanceCreatedBy), IList<ErrorResponse> errors = default(IList<ErrorResponse>), string state = default(string), string computeInstanceAuthorizationType = default(string), PersonalComputeInstanceSettings personalComputeInstanceSettings = default(PersonalComputeInstanceSettings), SetupScripts setupScripts = default(SetupScripts), ComputeInstanceLastOperation lastOperation = default(ComputeInstanceLastOperation))
        {
            VmSize = vmSize;
            Subnet = subnet;
