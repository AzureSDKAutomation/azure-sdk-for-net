...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class ComputeInstanceProperties
    {
        ...
        public ComputeInstanceProperties(string vmSize = default(string), ResourceId subnet = default(ResourceId), string applicationSharingPolicy = default(string), ComputeInstanceSshSettings sshSettings = default(ComputeInstanceSshSettings), ComputeInstanceConnectivityEndpoints connectivityEndpoints = default(ComputeInstanceConnectivityEndpoints), IList<ComputeInstanceApplication> applications = default(IList<ComputeInstanceApplication>), ComputeInstanceCreatedBy createdBy = default(ComputeInstanceCreatedBy), IList<MachineLearningServiceError> errors = default(IList<MachineLearningServiceError>), string state = default(string), string computeInstanceAuthorizationType = default(string), PersonalComputeInstanceSettings personalComputeInstanceSettings = default(PersonalComputeInstanceSettings), ComputeInstanceLastOperation lastOperation = default(ComputeInstanceLastOperation))
        {
            VmSize = vmSize;
            Subnet = subnet;
