...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    [Newtonsoft.Json.JsonObject("Generic")]
    public partial class ComponentInputGeneric : ComponentInput
    {
        /// <summary>
        /// Initializes a new instance of the ComponentInputGeneric class.
        /// </summary>
        public ComponentInputGeneric()
        {
            CustomInit();
        }
        ...
        public ComponentInputGeneric(string dataType, bool? optional = default(bool?), string description = default(string), string defaultProperty = default(string))
