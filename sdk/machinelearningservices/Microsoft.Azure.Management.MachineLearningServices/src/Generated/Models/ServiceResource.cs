...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class ServiceResource : Resource
    {
        ...
        public ServiceResource(string id = default(string), string name = default(string), Identity identity = default(Identity), string location = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku), ServiceResponseBase properties = default(ServiceResponseBase))
