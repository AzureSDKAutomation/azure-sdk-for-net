...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class Workspace : Resource
    {
        ...
        /// workspace.</param>
        /// <param name="storageHnsEnabled">If the storage associated with the
        /// workspace has HNS enabled.</param>
        /// <param name="mlFlowTrackingUri">The URI associated with this
        /// workspace that machine learning flow must point at to set up
        /// tracking.</param>
        ...
        public Workspace(string id = default(string), string name = default(string), string type = default(string), string workspaceId = default(string), string description = default(string), string friendlyName = default(string), string keyVault = default(string), string applicationInsights = default(string), string containerRegistry = default(string), string storageAccount = default(string), string discoveryUrl = default(string), string provisioningState = default(string), EncryptionProperty encryption = default(EncryptionProperty), bool? hbiWorkspace = default(bool?), string serviceProvisionedResourceGroup = default(string), int? privateLinkCount = default(int?), string imageBuildCompute = default(string), bool? allowPublicAccessWhenBehindVnet = default(bool?), string publicNetworkAccess = default(string), IList<PrivateEndpointConnection> privateEndpointConnections = default(IList<PrivateEndpointConnection>), IList<SharedPrivateLinkResource> sharedPrivateLinkResources = default(IList<SharedPrivateLinkResource>), NotebookResourceInfo notebookInfo = default(NotebookResourceInfo), ServiceManagedResourcesSettings serviceManagedResourcesSettings = default(ServiceManagedResourcesSettings), string primaryUserAssignedIdentity = default(string), string tenantId = default(string), string storageHnsEnabled = default(string), string mlFlowTrackingUri = default(string), Identity identity = default(Identity), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku), SystemData systemData = default(SystemData))
            : base(id, name, type)
        {
        ...
        /// <summary>
        /// Gets if the storage associated with the workspace has HNS enabled.
        /// </summary>
        [JsonProperty(PropertyName = "properties.storageHnsEnabled")]
        public string StorageHnsEnabled { get; private set; }

        /// <summary>
        /// Gets the URI associated with this workspace that machine learning
        /// flow must point at to set up tracking.
        /// </summary>
        [JsonProperty(PropertyName = "properties.mlFlowTrackingUri")]
        public string MlFlowTrackingUri { get; private set; }
