...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the AzurePostgreSqlSection class.
        /// </summary>
        public AzurePostgreSqlSection()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the AzurePostgreSqlSection class.
        /// </summary>
        /// <param name="credentials">Azure SQL database credentials.</param>
        ...
        /// <param name="enableSSL">Whether the Azure PostgreSQL server
        /// requires SSL.</param>
        public AzurePostgreSqlSection(DatastoreCredentials credentials, string databaseName, string endpoint, int portNumber, string serverName, bool? enableSSL = default(bool?))
        {
            EnableSSL = enableSSL;
        ...
        /// <summary>
        /// Gets or sets whether the Azure PostgreSQL server requires SSL.
        /// </summary>
        [JsonProperty(PropertyName = "enableSSL")]
        public bool? EnableSSL { get; set; }

        /// <summary>
        /// Gets or sets azure SQL database credentials.
        /// </summary>
