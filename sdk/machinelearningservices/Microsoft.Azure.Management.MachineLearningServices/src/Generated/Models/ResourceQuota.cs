...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class ResourceQuota
    {
        ...
        /// <param name="location">Region of the AML workspace in the
        /// id.</param>
        ...
        public ResourceQuota(string id = default(string), string location = default(string), string type = default(string), ResourceName name = default(ResourceName), long? limit = default(long?), string unit = default(string))
        {
            Id = id;
            Location = location;
            Type = type;
        ...
        /// <summary>
        /// Gets region of the AML workspace in the id.
        /// </summary>
