...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class Kubernetes
    {
        ...
        public Kubernetes(string computeType, string computeLocation = default(string), string provisioningState = default(string), string description = default(string), System.DateTime? createdOn = default(System.DateTime?), System.DateTime? modifiedOn = default(System.DateTime?), string resourceId = default(string), IList<ErrorResponse> provisioningErrors = default(IList<ErrorResponse>), bool? isAttachedCompute = default(bool?), bool? disableLocalAuth = default(bool?), KubernetesProperties properties = default(KubernetesProperties))
        {
