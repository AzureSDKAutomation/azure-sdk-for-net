...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class PartialOnlineDeploymentPartialTrackedResource
    {
        ...
        /// provider</param>
        public PartialOnlineDeploymentPartialTrackedResource(IDictionary<string, string> tags = default(IDictionary<string, string>), string location = default(string), string kind = default(string), ResourceIdentity identity = default(ResourceIdentity), string id = default(string), string name = default(string), string type = default(string), PartialOnlineDeployment properties = default(PartialOnlineDeployment), SystemData systemData = default(SystemData))
        {
            Tags = tags;
            Location = location;
            Kind = kind;
