...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    /// </summary>
    public partial class OnlineEndpointsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the OnlineEndpointsDeleteHeaders
        /// class.
        /// </summary>
        public OnlineEndpointsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        public OnlineEndpointsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
