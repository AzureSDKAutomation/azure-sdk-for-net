...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("Pipeline")]
    public partial class PipelineJob : ComputeJobBase
    {
        /// <summary>
        ...
        /// <param name="pipelineType">Type of PipelineJob. Possible values
        /// include: 'AzureML'</param>
        /// <param name="pipeline">Pipeline details.</param>
        public PipelineJob(ComputeBinding computeBinding, string provisioningState = default(string), JobBaseInteractionEndpoints interactionEndpoints = default(JobBaseInteractionEndpoints), string description = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), IDictionary<string, string> properties = default(IDictionary<string, string>), string experimentName = default(string), JobOutput output = default(JobOutput), int? priority = default(int?), string status = default(string), string pipelineType = default(string), Pipeline pipeline = default(Pipeline))
        ...
        /// <summary>
        /// Gets or sets type of PipelineJob. Possible values include:
        /// 'AzureML'
        /// </summary>
