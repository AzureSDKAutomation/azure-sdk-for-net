...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    public static partial class ModelContainersOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<ModelContainerResource> List(this IModelContainersOperations operations, string resourceGroupName, string workspaceName, string skiptoken = default(string), int? count = default(int?))
            {
                return operations.ListAsync(resourceGroupName, workspaceName, skiptoken, count).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<IPage<ModelContainerResource>> ListAsync(this IModelContainersOperations operations, string resourceGroupName, string workspaceName, string skiptoken = default(string), int? count = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListWithHttpMessagesAsync(resourceGroupName, workspaceName, skiptoken, count, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
