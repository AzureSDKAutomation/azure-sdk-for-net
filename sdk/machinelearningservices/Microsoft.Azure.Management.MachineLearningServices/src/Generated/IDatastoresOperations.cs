...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    public partial interface IDatastoresOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<DatastorePropertiesResource>> CreateOrUpdateWithHttpMessagesAsync(string name, string resourceGroupName, string workspaceName, DatastorePropertiesResource body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<DatastoreCredentials>> ListSecretsWithHttpMessagesAsync(string name, string resourceGroupName, string workspaceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List datastores.
        /// </summary>
