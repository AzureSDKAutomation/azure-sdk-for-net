...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    public static partial class CodeVersionsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<CodeVersionResource> List(this ICodeVersionsOperations operations, string name, string resourceGroupName, string workspaceName, string orderBy = default(string), int? top = default(int?), string skiptoken = default(string))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<CodeVersionResource>> ListAsync(this ICodeVersionsOperations operations, string name, string resourceGroupName, string workspaceName, string orderBy = default(string), int? top = default(int?), string skiptoken = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
