...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    public partial class AzureMachineLearningWorkspacesClient : ServiceClient<AzureMachineLearningWorkspacesClient>, IAzureMachineLearningWorkspacesClient, IAzureClient
    {
        ...
        /// <summary>
        /// Gets the IComponentContainersOperations.
        /// </summary>
        public virtual IComponentContainersOperations ComponentContainers { get; private set; }

        /// <summary>
        /// Gets the IComponentVersionsOperations.
        /// </summary>
        public virtual IComponentVersionsOperations ComponentVersions { get; private set; }
        ...
        private void Initialize()
        {
            ...
            ComponentContainers = new ComponentContainersOperations(this);
            ComponentVersions = new ComponentVersionsOperations(this);
            ...
            SerializationSettings.Converters.Add(new PolymorphicSerializeJsonConverter<ComponentInput>("componentInputType"));
            DeserializationSettings.Converters.Add(new PolymorphicDeserializeJsonConverter<ComponentInput>("componentInputType"));
            ...
            SerializationSettings.Converters.Add(new PolymorphicSerializeJsonConverter<EarlyTerminationPolicyConfiguration>("policyType"));
            DeserializationSettings.Converters.Add(new PolymorphicDeserializeJsonConverter<EarlyTerminationPolicyConfiguration>("policyType"));
            ...
            SerializationSettings.Converters.Add(new PolymorphicSerializeJsonConverter<DeploymentConfigurationBase>("computeType"));
            DeserializationSettings.Converters.Add(new PolymorphicDeserializeJsonConverter<DeploymentConfigurationBase>("computeType"));
            ...
            SerializationSettings.Converters.Add(new PolymorphicSerializeJsonConverter<ComputeConfiguration>("computeType"));
            DeserializationSettings.Converters.Add(new PolymorphicDeserializeJsonConverter<ComputeConfiguration>("computeType"));
            CustomInitialize();
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<WorkspaceSku>>> ListSkusWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (ApiVersion == null)
            {
            ...
            if ((int)_statusCode != 200)
            {
                ...
                try
                {
                    ...
                    MachineLearningServiceError _errorBody =  SafeJsonConvert.DeserializeObject<MachineLearningServiceError>(_responseContent, DeserializationSettings);
                    if (_errorBody != null)
                    {
                        ex.Body = _errorBody;
                    }
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<WorkspaceSku>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<Page1<WorkspaceSku>>(_responseContent, DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<WorkspaceSku>>> ListSkusNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
