...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    public static partial class MachineLearningServiceOperationsExtensions
    {
            ...
            {
                using (var _result = await operations.ListByWorkspaceWithHttpMessagesAsync(resourceGroupName, workspaceName, skiptoken, modelId, modelName, tag, tags, properties, runId, expand, orderby, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
