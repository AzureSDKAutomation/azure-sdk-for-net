...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    public static partial class IntegrationRuntimesOperationsExtensions
    {
            ...
            /// The integration runtime name.
            /// </param>
            public static IntegrationRuntimeOutboundNetworkDependenciesEndpointsResponse OutboundNetworkDependenciesEndpoints(this IIntegrationRuntimesOperations operations, string resourceGroupName, string factoryName, string integrationRuntimeName)
            {
                return operations.OutboundNetworkDependenciesEndpointsAsync(resourceGroupName, factoryName, integrationRuntimeName).GetAwaiter().GetResult();
            }
            ...
            {
                using (var _result = await operations.OutboundNetworkDependenciesEndpointsWithHttpMessagesAsync(resourceGroupName, factoryName, integrationRuntimeName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
