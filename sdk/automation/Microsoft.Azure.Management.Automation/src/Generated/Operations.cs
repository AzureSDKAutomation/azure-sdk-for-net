...
namespace Microsoft.Azure.Management.Automation
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<AutomationClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AutomationClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IEnumerable<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Automation/operations").ToString();
