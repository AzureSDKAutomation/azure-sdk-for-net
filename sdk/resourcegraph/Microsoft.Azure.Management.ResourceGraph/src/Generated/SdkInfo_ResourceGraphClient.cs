      ...
      public static IEnumerable<Tuple<string, string, string>> ApiInfo_ResourceGraphClient
      {
          get
          {
              return new Tuple<string, string, string>[]
              {
                ...
                new Tuple<string, string, string>("ResourceGraph", "ResourceChangeDetails", "2020-09-01-preview"),
                new Tuple<string, string, string>("ResourceGraph", "ResourceChanges", "2020-09-01-preview"),
                new Tuple<string, string, string>("ResourceGraph", "Resources", "2020-04-01-preview"),
                new Tuple<string, string, string>("ResourceGraph", "ResourcesHistory", "2020-04-01-preview"),
              }.AsEnumerable();
          }
      }
  }
