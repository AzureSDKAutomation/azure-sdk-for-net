...
namespace Microsoft.Azure.Management.Synapse
{
    ...
    /// </summary>
    internal partial class SparkConfigurationOperations : IServiceOperations<SynapseManagementClient>, ISparkConfigurationOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<SparkConfigurationResource>> GetWithHttpMessagesAsync(string resourceGroupName, string sparkConfigurationName, string workspaceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<SparkConfigurationResource>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<SparkConfigurationResource>(_responseContent, Client.DeserializationSettings);
                }
