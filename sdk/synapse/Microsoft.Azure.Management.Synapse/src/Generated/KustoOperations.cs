...
namespace Microsoft.Azure.Management.Synapse
{
    ...
    /// </summary>
    internal partial class KustoOperations : IServiceOperations<SynapseManagementClient>, IKustoOperations
    {
        /// <summary>
        /// Initializes a new instance of the KustoOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal KustoOperations(SynapseManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Synapse/kustooperations").ToString();
