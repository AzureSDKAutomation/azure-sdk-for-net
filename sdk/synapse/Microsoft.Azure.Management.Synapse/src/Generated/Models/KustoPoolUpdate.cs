...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class KustoPoolUpdate : Resource
    {
        ...
        /// 'V2', 'V3'</param>
        public KustoPoolUpdate(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), AzureSku sku = default(AzureSku), string state = default(string), string provisioningState = default(string), string uri = default(string), string dataIngestionUri = default(string), string stateReason = default(string), string engineType = default(string))
            : base(id, name, type)
        {
            Tags = tags;
            Sku = sku;
