...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class SparkConfigurationResource : SubResource
    {
        ...
        public SparkConfigurationResource(string configs, string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string description = default(string), IList<string> annotations = default(IList<string>), string notes = default(string))
