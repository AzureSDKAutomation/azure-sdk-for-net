...
namespace Microsoft.Azure.Management.ContainerService
{
    ...
    public partial interface IMaintenanceConfigurationsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<MaintenanceConfiguration>>> ListWithHttpMessagesAsync(string resourceGroupName, string resourceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<IPage<MaintenanceConfiguration>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
