...
namespace Microsoft.Azure.Management.ContainerService.Models
{
    ...
    /// </summary>
    public partial class ManagedClusterCloudErrorBody
    {
        /// <summary>
        /// Initializes a new instance of the ManagedClusterCloudErrorBody
        /// class.
        /// </summary>
        public ManagedClusterCloudErrorBody()
        {
            CustomInit();
        }
        ...
        /// error.</param>
        public ManagedClusterCloudErrorBody(string code = default(string), string message = default(string), string target = default(string), IList<ManagedClusterCloudErrorBody> details = default(IList<ManagedClusterCloudErrorBody>))
        {
            Code = code;
            Message = message;
            Target = target;
        ...
        public IList<ManagedClusterCloudErrorBody> Details { get; set; }
