...
namespace Microsoft.Azure.Management.PostgreSQL
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<HyperscaleCitusManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(HyperscaleCitusManagementClient client)
        {
            if (client == null)
            {
