...
namespace Microsoft.Azure.Management.PostgreSQL.Models
{
    ...
    public partial class ServerConfiguration : ProxyResource
    {
        ...
        /// configuration.</param>
        public ServerConfiguration(string value, string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string source = default(string), string description = default(string), string defaultValue = default(string), string dataType = default(string), string allowedValues = default(string))
            : base(id, name, type)
        {
