...
namespace Microsoft.Azure.Management.PostgreSQL.Models
{
    ...
    public partial class ServerRoleGroup : ServerProperties
    {
        ...
        /// role group.</param>
        public ServerRoleGroup(string serverEdition = default(string), long? storageQuotaInMb = default(long?), long? vCores = default(long?), int? standbyCount = default(int?), bool? isPublicIpRequested = default(bool?), string name = default(string), string role = default(string), int? serverCount = default(int?), IList<ServerNameItem> serverNames = default(IList<ServerNameItem>))
