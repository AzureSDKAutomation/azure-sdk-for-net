...
namespace Microsoft.Azure.Management.PostgreSQL.Models
{
    ...
    public partial class FirewallRule : ProxyResource
    {
        ...
        /// group firewall rule. Must be IPv4 format.</param>
        /// <param name="endIpAddress">The end IP address of the server group
        ...
        /// <summary>
        /// Gets or sets the start IP address of the server group firewall
        ...
        /// <summary>
        /// Gets or sets the end IP address of the server group firewall rule.
        /// Must be IPv4 format.
        /// </summary>
