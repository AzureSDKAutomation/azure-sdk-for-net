...
namespace Microsoft.Azure.Management.PostgreSQL.Models
{
    ...
    public partial class ServerGroupServer : ProxyResource
    {
        ...
        /// include: '11', '12'</param>
        public ServerGroupServer(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string serverEdition = default(string), long? storageQuotaInMb = default(long?), long? vCores = default(long?), int? standbyCount = default(int?), bool? isPublicIpRequested = default(bool?), string fullyQualifiedDomainName = default(string), string role = default(string), string state = default(string), string haState = default(string), string administratorLogin = default(string), string version = default(string))
            : base(id, name, type)
        {
        ...
        /// 'Stopping', 'Stopped', 'Updating', 'Provisioning'
        /// </summary>
