...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    /// </summary>
    internal partial class BackupCrrJobDetailsOperations : IServiceOperations<RecoveryServicesBackupClient>, IBackupCrrJobDetailsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<JobResource>> GetWithHttpMessagesAsync(string azureRegion, CrrJobRequest parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (azureRegion == null)
            {
