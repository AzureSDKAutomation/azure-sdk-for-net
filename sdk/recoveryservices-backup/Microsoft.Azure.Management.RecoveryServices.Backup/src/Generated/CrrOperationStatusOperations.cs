...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    /// </summary>
    internal partial class CrrOperationStatusOperations : IServiceOperations<RecoveryServicesBackupClient>, ICrrOperationStatusOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<OperationStatus>> GetWithHttpMessagesAsync(string azureRegion, string operationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (azureRegion == null)
            {
