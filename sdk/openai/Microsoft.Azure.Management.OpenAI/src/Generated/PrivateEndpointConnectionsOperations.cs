...
namespace Microsoft.Azure.Management.OpenAI
{
    ...
    /// </summary>
    internal partial class PrivateEndpointConnectionsOperations : IServiceOperations<OpenAIManagementClient>, IPrivateEndpointConnectionsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal PrivateEndpointConnectionsOperations(OpenAIManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<PrivateEndpointConnectionListResult>> ListWithHttpMessagesAsync(string resourceGroupName, string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OpenAI/accounts/{accountName}/privateEndpointConnections").ToString();
        ...
        /// <summary>
        /// Gets the specified private endpoint connection associated with the OpenAI
        /// account.
        /// </summary>
        /// <param name='resourceGroupName'>
        /// The name of the resource group. The name is case insensitive.
        ...
        /// The name of the private endpoint connection associated with the OpenAI
        /// Account
        /// </param>
        /// <param name='customHeaders'>
        /// Headers that will be added to request.
        ...
        public async Task<AzureOperationResponse<PrivateEndpointConnection>> GetWithHttpMessagesAsync(string resourceGroupName, string accountName, string privateEndpointConnectionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OpenAI/accounts/{accountName}/privateEndpointConnections/{privateEndpointConnectionName}").ToString();
            _url = _url.Replace("{resourceGroupName}", System.Uri.EscapeDataString(resourceGroupName));
            _url = _url.Replace("{accountName}", System.Uri.EscapeDataString(accountName));
            _url = _url.Replace("{subscriptionId}", System.Uri.EscapeDataString(Client.SubscriptionId));
        ...
        {
            // Send Request
            AzureOperationResponse<PrivateEndpointConnection> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, accountName, privateEndpointConnectionName, properties, customHeaders, cancellationToken).ConfigureAwait(false);
