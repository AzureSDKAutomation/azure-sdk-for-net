...
namespace Microsoft.Azure.Management.OpenAI
{
    ...
    /// </summary>
    internal partial class ResourceSkusOperations : IServiceOperations<OpenAIManagementClient>, IResourceSkusOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ResourceSkusOperations(OpenAIManagementClient client)
        {
            if (client == null)
            {
        ...
        /// <summary>
        /// Gets the list of Microsoft.OpenAI SKUs available for your Subscription.
        /// </summary>
        ...
        public async Task<AzureOperationResponse<IPage<ResourceSku>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.OpenAI/skus").ToString();
