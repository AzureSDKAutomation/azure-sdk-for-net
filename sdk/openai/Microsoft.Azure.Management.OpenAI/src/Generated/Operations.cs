...
namespace Microsoft.Azure.Management.OpenAI
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<OpenAIManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(OpenAIManagementClient client)
        {
            if (client == null)
            {
        ...
        /// <summary>
        /// Lists all the available OpenAI account operations.
        /// </summary>
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.OpenAI/operations").ToString();
