...
namespace Microsoft.Azure.Management.OpenAI.Models
{
    ...
    public partial class ResourceSkuRestrictions
    {
        ...
        public ResourceSkuRestrictions(ResourceSkuRestrictionsType? type = default(ResourceSkuRestrictionsType?), IList<string> values = default(IList<string>), ResourceSkuRestrictionInfo restrictionInfo = default(ResourceSkuRestrictionInfo), string reasonCode = default(string))
        {
            Type = type;
            Values = values;
