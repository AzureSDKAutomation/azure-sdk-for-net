...
namespace Microsoft.Azure.Management.OpenAI.Models
{
    ...
    /// <summary>
    /// Describes an available OpenAI SKU.
    /// </summary>
    public partial class ResourceSku
    {
        ...
        /// <param name="tier">Specifies the tier of OpenAI account.</param>
        ...
        public ResourceSku(string resourceType = default(string), string name = default(string), string tier = default(string), IList<string> locations = default(IList<string>), IList<ResourceSkuRestrictions> restrictions = default(IList<ResourceSkuRestrictions>))
        {
        ...
        /// <summary>
        /// Gets or sets specifies the tier of OpenAI account.
        /// </summary>
