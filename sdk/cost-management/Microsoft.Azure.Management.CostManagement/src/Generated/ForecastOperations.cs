...
namespace Microsoft.Azure.Management.CostManagement
{
    ...
    /// </summary>
    internal partial class ForecastOperations : IServiceOperations<CostManagementClient>, IForecastOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<QueryResult>> UsageWithHttpMessagesAsync(string scope, ForecastDefinition parameters, string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (scope == null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<QueryResult>> ExternalCloudProviderUsageWithHttpMessagesAsync(string externalCloudProviderType, string externalCloudProviderId, ForecastDefinition parameters, string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
