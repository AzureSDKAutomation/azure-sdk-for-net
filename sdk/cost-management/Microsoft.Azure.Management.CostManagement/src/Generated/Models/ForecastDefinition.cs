...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class ForecastDefinition
    {
        ...
        public ForecastDefinition(string type, string timeframe, QueryDataset dataSet, QueryTimePeriod timePeriod = default(QueryTimePeriod), bool? includeActualCost = default(bool?), bool? includeFreshPartialCost = default(bool?))
        {
            Type = type;
            Timeframe = timeframe;
