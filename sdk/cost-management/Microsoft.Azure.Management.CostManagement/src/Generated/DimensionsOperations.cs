...
namespace Microsoft.Azure.Management.CostManagement
{
    ...
    /// </summary>
    internal partial class DimensionsOperations : IServiceOperations<CostManagementClient>, IDimensionsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<Dimension>>> ListWithHttpMessagesAsync(string scope, ODataQuery<Dimension> odataQuery = default(ODataQuery<Dimension>), string skiptoken = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (scope == null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<Dimension>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<Dimension>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<Dimension>>> ByExternalCloudProviderTypeWithHttpMessagesAsync(string externalCloudProviderType, string externalCloudProviderId, ODataQuery<Dimension> odataQuery = default(ODataQuery<Dimension>), string skiptoken = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
