      ...
      public static IEnumerable<Tuple<string, string, string>> ApiInfo_CostManagementClient
      {
          get
          {
              return new Tuple<string, string, string>[]
              {
                ...
                new Tuple<string, string, string>("CostManagement", "GenerateDetailedCostReport", "2020-06-01"),
                new Tuple<string, string, string>("CostManagement", "GenerateDetailedCostReportOperationResults", "2020-06-01"),
                new Tuple<string, string, string>("CostManagement", "GenerateDetailedCostReportOperationStatus", "2020-06-01"),
