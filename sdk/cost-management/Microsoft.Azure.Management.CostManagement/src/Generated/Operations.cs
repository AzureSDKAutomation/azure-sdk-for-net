...
namespace Microsoft.Azure.Management.CostManagement
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<CostManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(CostManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.CostManagement/operations").ToString();
