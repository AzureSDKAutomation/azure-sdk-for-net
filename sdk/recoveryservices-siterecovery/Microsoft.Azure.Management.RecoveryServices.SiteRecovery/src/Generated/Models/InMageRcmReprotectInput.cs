...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery.Models
{
    ...
    public partial class InMageRcmReprotectInput : ReverseReplicationProviderSpecificInput
    {
        ...
        public InMageRcmReprotectInput(string reprotectAgentId = default(string), string datastoreName = default(string), string logStorageAccountId = default(string), string policyId = default(string))
        {
