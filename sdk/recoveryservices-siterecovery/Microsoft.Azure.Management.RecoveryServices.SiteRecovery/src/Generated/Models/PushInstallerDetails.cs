...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery.Models
{
    ...
    public partial class PushInstallerDetails
    {
        ...
        public PushInstallerDetails(string id = default(string), string name = default(string), string biosId = default(string), string fqdn = default(string), string version = default(string), System.DateTime? lastHeartbeatUtc = default(System.DateTime?), string health = default(string), IList<HealthError> healthErrors = default(IList<HealthError>))
        {
            Id = id;
            Name = name;
            BiosId = biosId;
