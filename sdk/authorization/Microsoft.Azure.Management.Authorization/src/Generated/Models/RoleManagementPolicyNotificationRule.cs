...
namespace Microsoft.Azure.Management.Authorization.Models
{
    ...
    public partial class RoleManagementPolicyNotificationRule : RoleManagementPolicyRule
    {
        ...
        /// <param name="notificationRecipients">The list notification
        /// recipients.</param>
        /// <param name="isDefaultRecipientsEnabled">Its value determine if the
        /// notification need to be sent to the recipient type specified in
        /// policy rule.</param>
        ...
        /// <summary>
        /// Gets or sets the list notification recipients.
        /// </summary>
        [JsonProperty(PropertyName = "notificationRecipients")]
        public IList<string> NotificationRecipients { get; set; }

        /// <summary>
        /// Gets or sets its value determine if the notification need to be
        /// sent to the recipient type specified in policy rule.
        /// </summary>
