...
namespace Microsoft.Azure.Management.Authorization.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the RoleAssignmentScheduleRequest
        /// class.
        /// </summary>
        ...
        /// <param name="id">The role assignment schedule request ID.</param>
        /// <param name="name">The role assignment schedule request
        /// name.</param>
        /// <param name="type">The role assignment schedule request
        /// type.</param>
        /// <param name="scope">The role assignment schedule request
        /// scope.</param>
        ...
        /// <param name="approvalId">The approvalId of the role assignment
        /// schedule request.</param>
        /// <param name="targetRoleAssignmentScheduleId">The resultant role
        /// assignment schedule id or the role assignment schedule id being
        /// updated</param>
        /// <param name="targetRoleAssignmentScheduleInstanceId">The role
        /// assignment schedule instance id being updated</param>
        /// <param name="scheduleInfo">Schedule info of the role assignment
        /// schedule</param>
        /// <param name="linkedRoleEligibilityScheduleId">The linked role
        /// eligibility schedule id - to activate an eligibility.</param>
        ...
        /// <param name="createdOn">DateTime when role assignment schedule
        ...
        public RoleAssignmentScheduleRequest(string roleDefinitionId, string principalId, string requestType, string id = default(string), string name = default(string), string type = default(string), string scope = default(string), string principalType = default(string), string status = default(string), string approvalId = default(string), string targetRoleAssignmentScheduleId = default(string), string targetRoleAssignmentScheduleInstanceId = default(string), RoleAssignmentScheduleRequestPropertiesScheduleInfo scheduleInfo = default(RoleAssignmentScheduleRequestPropertiesScheduleInfo), string linkedRoleEligibilityScheduleId = default(string), string justification = default(string), RoleAssignmentScheduleRequestPropertiesTicketInfo ticketInfo = default(RoleAssignmentScheduleRequestPropertiesTicketInfo), string condition = default(string), string conditionVersion = default(string), System.DateTime? createdOn = default(System.DateTime?), string requestorId = default(string), ExpandedProperties expandedProperties = default(ExpandedProperties))
        {
            Id = id;
            Name = name;
            Type = type;
        ...
        /// <summary>
        /// Gets the role assignment schedule request ID.
        /// </summary>
        [JsonProperty(PropertyName = "id")]
        public string Id { get; private set; }

        /// <summary>
        /// Gets the role assignment schedule request name.
        /// </summary>
        [JsonProperty(PropertyName = "name")]
        public string Name { get; private set; }

        /// <summary>
        /// Gets the role assignment schedule request type.
        /// </summary>
        [JsonProperty(PropertyName = "type")]
        public string Type { get; private set; }

        /// <summary>
        /// Gets the role assignment schedule request scope.
        /// </summary>
        ...
        /// values include: 'User', 'Group', 'ServicePrincipal', 'Unknown',
        ...
        /// <summary>
        /// Gets the status of the role assignment schedule request. Possible
        ...
        /// <summary>
        /// Gets the approvalId of the role assignment schedule request.
        /// </summary>
        [JsonProperty(PropertyName = "properties.approvalId")]
        public string ApprovalId { get; private set; }

        /// <summary>
        /// Gets or sets the resultant role assignment schedule id or the role
        /// assignment schedule id being updated
        /// </summary>
        [JsonProperty(PropertyName = "properties.targetRoleAssignmentScheduleId")]
        public string TargetRoleAssignmentScheduleId { get; set; }

        /// <summary>
        /// Gets or sets the role assignment schedule instance id being updated
        /// </summary>
        [JsonProperty(PropertyName = "properties.targetRoleAssignmentScheduleInstanceId")]
        public string TargetRoleAssignmentScheduleInstanceId { get; set; }

        /// <summary>
        /// Gets or sets schedule info of the role assignment schedule
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the linked role eligibility schedule id - to activate
        /// an eligibility.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets justification for the role assignment
        /// </summary>
        [JsonProperty(PropertyName = "properties.justification")]
        public string Justification { get; set; }

        /// <summary>
        /// Gets or sets ticket Info of the role assignment
        /// </summary>
        ...
        /// <summary>
        /// Gets dateTime when role assignment schedule request was created
        /// </summary>
