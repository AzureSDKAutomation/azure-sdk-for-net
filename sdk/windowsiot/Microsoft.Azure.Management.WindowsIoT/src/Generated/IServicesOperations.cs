...
namespace Microsoft.Azure.Management.WindowsIoT
{
    ...
    public partial interface IServicesOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<DeviceService>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string deviceName, DeviceService deviceService, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
