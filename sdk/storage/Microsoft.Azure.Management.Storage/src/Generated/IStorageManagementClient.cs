...
namespace Microsoft.Azure.Management.Storage
{
    ...
    public partial interface IStorageManagementClient : System.IDisposable
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<ListQueueResource>> ListQueueMethodWithHttpMessagesAsync(string resourceGroupName, string accountName, string maxpagesize = default(string), string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<ListTableResource>> QueryTableWithHttpMessagesAsync(string resourceGroupName, string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
