...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public static partial class BillingSubscriptionsOperationsExtensions
    {
            ...
            /// </param>
            public static BillingSubscription Get(this IBillingSubscriptionsOperations operations, string billingAccountName, string billingSubscriptionId)
            {
                return operations.GetAsync(billingAccountName, billingSubscriptionId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BillingSubscription> GetAsync(this IBillingSubscriptionsOperations operations, string billingAccountName, string billingSubscriptionId, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetWithHttpMessagesAsync(billingAccountName, billingSubscriptionId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// operation.
            /// </param>
            public static BillingSubscription Update(this IBillingSubscriptionsOperations operations, string billingAccountName, string billingSubscriptionId, BillingSubscriptionUpdateRequest parameters)
            {
                return operations.UpdateAsync(billingAccountName, billingSubscriptionId, parameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BillingSubscription> UpdateAsync(this IBillingSubscriptionsOperations operations, string billingAccountName, string billingSubscriptionId, BillingSubscriptionUpdateRequest parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.UpdateWithHttpMessagesAsync(billingAccountName, billingSubscriptionId, parameters, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// <summary>
            /// Lists the subscriptions for a billing profile. The operation is supported
            /// for billing accounts with agreement type Microsoft Customer Agreement or
            /// Microsoft Partner Agreement or Microsoft Online Services Program Agreement.
            /// <see href="https://docs.microsoft.com/en-us/rest/api/billing/" />
            /// </summary>
            ...
            /// <summary>
            /// Lists the subscriptions for an invoice section. The operation is supported
            /// for billing profiles with agreement type Microsoft Customer Agreement or
            /// Microsoft Partner Agreement or Microsoft Online Services Program Agreement.
            /// <see href="https://docs.microsoft.com/en-us/rest/api/billing/" />
            /// </summary>
            /// <param name='operations'>
