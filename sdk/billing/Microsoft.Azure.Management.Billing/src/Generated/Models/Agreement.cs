...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    public partial class Agreement : Resource
    {
        ...
        /// <param name="billingProfileInfo">Details about billing
        /// profile.</param>
        ...
        public Agreement(string id = default(string), string name = default(string), string type = default(string), string agreementLink = default(string), string category = default(string), string acceptanceMode = default(string), object billingProfileInfo = default(object), System.DateTime? effectiveDate = default(System.DateTime?), System.DateTime? expirationDate = default(System.DateTime?), IList<Participants> participants = default(IList<Participants>), string status = default(string))
            : base(id, name, type)
        {
        ...
        /// <summary>
        /// Gets or sets details about billing profile.
        /// </summary>
        [JsonProperty(PropertyName = "properties.billingProfileInfo")]
        public object BillingProfileInfo { get; set; }
