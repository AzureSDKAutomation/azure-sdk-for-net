...
namespace Microsoft.Azure.Management.Quota
{
    ...
    /// </summary>
    internal partial class OperationOperations : IServiceOperations<AzureQuotaExtensionAPIClient>, IOperationOperations
    {
        /// <summary>
        ...
        public async Task<AzureOperationResponse<IPage<OperationResponse>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = _baseUrl + (_baseUrl.EndsWith("/") ? "" : "/") + "providers/Microsoft.Quota/operations";
