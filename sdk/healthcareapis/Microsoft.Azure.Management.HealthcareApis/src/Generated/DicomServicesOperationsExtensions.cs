...
namespace Microsoft.Azure.Management.HealthcareApis
{
    ...
    public static partial class DicomServicesOperationsExtensions
    {
            ...
            /// The name of workspace resource.
            /// </param>
            public static DicomService Delete(this IDicomServicesOperations operations, string resourceGroupName, string dicomServiceName, string workspaceName)
            {
                return operations.DeleteAsync(resourceGroupName, dicomServiceName, workspaceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DicomService> DeleteAsync(this IDicomServicesOperations operations, string resourceGroupName, string dicomServiceName, string workspaceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.DeleteWithHttpMessagesAsync(resourceGroupName, dicomServiceName, workspaceName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The name of workspace resource.
            /// </param>
            public static DicomService BeginDelete(this IDicomServicesOperations operations, string resourceGroupName, string dicomServiceName, string workspaceName)
            {
                return operations.BeginDeleteAsync(resourceGroupName, dicomServiceName, workspaceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DicomService> BeginDeleteAsync(this IDicomServicesOperations operations, string resourceGroupName, string dicomServiceName, string workspaceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginDeleteWithHttpMessagesAsync(resourceGroupName, dicomServiceName, workspaceName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
