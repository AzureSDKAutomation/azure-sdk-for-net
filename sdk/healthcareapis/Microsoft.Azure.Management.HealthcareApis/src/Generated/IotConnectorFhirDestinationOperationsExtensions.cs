...
namespace Microsoft.Azure.Management.HealthcareApis
{
    ...
    public static partial class IotConnectorFhirDestinationOperationsExtensions
    {
            ...
            /// The name of IoT Connector FHIR destination resource.
            /// </param>
            public static IotFhirDestination Delete(this IIotConnectorFhirDestinationOperations operations, string resourceGroupName, string workspaceName, string iotConnectorName, string fhirDestinationName)
            {
                return operations.DeleteAsync(resourceGroupName, workspaceName, iotConnectorName, fhirDestinationName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IotFhirDestination> DeleteAsync(this IIotConnectorFhirDestinationOperations operations, string resourceGroupName, string workspaceName, string iotConnectorName, string fhirDestinationName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.DeleteWithHttpMessagesAsync(resourceGroupName, workspaceName, iotConnectorName, fhirDestinationName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The name of IoT Connector FHIR destination resource.
            /// </param>
            public static IotFhirDestination BeginDelete(this IIotConnectorFhirDestinationOperations operations, string resourceGroupName, string workspaceName, string iotConnectorName, string fhirDestinationName)
            {
                return operations.BeginDeleteAsync(resourceGroupName, workspaceName, iotConnectorName, fhirDestinationName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IotFhirDestination> BeginDeleteAsync(this IIotConnectorFhirDestinationOperations operations, string resourceGroupName, string workspaceName, string iotConnectorName, string fhirDestinationName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginDeleteWithHttpMessagesAsync(resourceGroupName, workspaceName, iotConnectorName, fhirDestinationName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
