...
namespace Microsoft.Azure.Management.HealthcareApis
{
    ...
    public static partial class WorkspacesOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Workspace> DeleteAsync(this IWorkspacesOperations operations, string resourceGroupName, string workspaceName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Workspace> BeginDeleteAsync(this IWorkspacesOperations operations, string resourceGroupName, string workspaceName, CancellationToken cancellationToken = default(CancellationToken))
            {
