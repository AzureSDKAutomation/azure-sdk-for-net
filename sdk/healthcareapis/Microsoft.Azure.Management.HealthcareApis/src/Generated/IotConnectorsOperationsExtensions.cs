...
namespace Microsoft.Azure.Management.HealthcareApis
{
    ...
    public static partial class IotConnectorsOperationsExtensions
    {
            ...
            /// The name of workspace resource.
            /// </param>
            public static IotConnector Delete(this IIotConnectorsOperations operations, string resourceGroupName, string iotConnectorName, string workspaceName)
            {
                return operations.DeleteAsync(resourceGroupName, iotConnectorName, workspaceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IotConnector> DeleteAsync(this IIotConnectorsOperations operations, string resourceGroupName, string iotConnectorName, string workspaceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.DeleteWithHttpMessagesAsync(resourceGroupName, iotConnectorName, workspaceName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The name of workspace resource.
            /// </param>
            public static IotConnector BeginDelete(this IIotConnectorsOperations operations, string resourceGroupName, string iotConnectorName, string workspaceName)
            {
                return operations.BeginDeleteAsync(resourceGroupName, iotConnectorName, workspaceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IotConnector> BeginDeleteAsync(this IIotConnectorsOperations operations, string resourceGroupName, string iotConnectorName, string workspaceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginDeleteWithHttpMessagesAsync(resourceGroupName, iotConnectorName, workspaceName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
