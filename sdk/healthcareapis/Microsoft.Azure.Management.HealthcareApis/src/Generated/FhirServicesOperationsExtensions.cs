...
namespace Microsoft.Azure.Management.HealthcareApis
{
    ...
    public static partial class FhirServicesOperationsExtensions
    {
            ...
            /// The name of workspace resource.
            /// </param>
            public static FhirService Delete(this IFhirServicesOperations operations, string resourceGroupName, string fhirServiceName, string workspaceName)
            {
                return operations.DeleteAsync(resourceGroupName, fhirServiceName, workspaceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<FhirService> DeleteAsync(this IFhirServicesOperations operations, string resourceGroupName, string fhirServiceName, string workspaceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.DeleteWithHttpMessagesAsync(resourceGroupName, fhirServiceName, workspaceName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The name of workspace resource.
            /// </param>
            public static FhirService BeginDelete(this IFhirServicesOperations operations, string resourceGroupName, string fhirServiceName, string workspaceName)
            {
                return operations.BeginDeleteAsync(resourceGroupName, fhirServiceName, workspaceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<FhirService> BeginDeleteAsync(this IFhirServicesOperations operations, string resourceGroupName, string fhirServiceName, string workspaceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginDeleteWithHttpMessagesAsync(resourceGroupName, fhirServiceName, workspaceName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
