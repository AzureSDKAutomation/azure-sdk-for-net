...
namespace Azure.Messaging.WebPubSub
{
    ...
    public static partial class HealthApiExtensions
    {
            ...
            /// </param>
            public static void GetServiceStatus(this IHealthApi operations, string apiVersion = "2021-08-01-preview")
            {
            ...
            /// </param>
            public static async Task GetServiceStatusAsync(this IHealthApi operations, string apiVersion = "2021-08-01-preview", CancellationToken cancellationToken = default(CancellationToken))
            {
