...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters
{
    ...
    /// </summary>
    internal partial class ManagedClusterVersionOperations : IServiceOperations<ServiceFabricManagedClustersManagementClient>, IManagedClusterVersionOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<ManagedClusterCodeVersionResult>> GetWithHttpMessagesAsync(string location, string clusterVersion, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ManagedClusterCodeVersionResult>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ManagedClusterCodeVersionResult>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ManagedClusterCodeVersionResult>> GetByEnvironmentWithHttpMessagesAsync(string location, string clusterVersion, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "location");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ManagedClusterCodeVersionListResult>> ListWithHttpMessagesAsync(string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "location");
            ...
            // Create Result
            var _result = new AzureOperationResponse<ManagedClusterCodeVersionListResult>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ManagedClusterCodeVersionListResult>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ManagedClusterCodeVersionListResult>> ListByEnvironmentWithHttpMessagesAsync(string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "location");
