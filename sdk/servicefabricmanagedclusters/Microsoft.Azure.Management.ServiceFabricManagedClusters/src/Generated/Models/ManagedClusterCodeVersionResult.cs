...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ManagedClusterCodeVersionResult
    {
        ...
        public ManagedClusterCodeVersionResult(string id = default(string), string name = default(string), string type = default(string), string codeVersion = default(string), string supportExpiryUtc = default(string), string osType = default(string))
        {
            Id = id;
            Name = name;
            Type = type;
