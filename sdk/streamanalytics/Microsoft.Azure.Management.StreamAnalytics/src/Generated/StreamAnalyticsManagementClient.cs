...
namespace Microsoft.Azure.Management.StreamAnalytics
{
    ...
    public partial class StreamAnalyticsManagementClient : ServiceClient<StreamAnalyticsManagementClient>, IStreamAnalyticsManagementClient, IAzureClient
    {
        ...
        /// True: will dispose the provided httpClient on calling StreamAnalyticsManagementClient.Dispose(). False: will not dispose provided httpClient</param>
        protected StreamAnalyticsManagementClient(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public StreamAnalyticsManagementClient(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
