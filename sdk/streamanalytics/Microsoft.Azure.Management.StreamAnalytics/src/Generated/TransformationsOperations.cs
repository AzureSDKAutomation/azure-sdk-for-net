...
namespace Microsoft.Azure.Management.StreamAnalytics
{
    ...
    /// </summary>
    internal partial class TransformationsOperations : IServiceOperations<StreamAnalyticsManagementClient>, ITransformationsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal TransformationsOperations(StreamAnalyticsManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<Transformation,TransformationsCreateOrReplaceHeaders>> CreateOrReplaceWithHttpMessagesAsync(Transformation transformation, string resourceGroupName, string jobName, string transformationName, string ifMatch = default(string), string ifNoneMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StreamAnalytics/streamingjobs/{jobName}/transformations/{transformationName}").ToString();
            ...
            if(transformation != null)
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(transformation, Client.SerializationSettings);
            ...
            // Create Result
            var _result = new AzureOperationResponse<Transformation,TransformationsCreateOrReplaceHeaders>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Transformation>(_responseContent, Client.DeserializationSettings);
                }
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<TransformationsCreateOrReplaceHeaders>(JsonSerializer.Create(Client.DeserializationSettings));
            }
            catch (JsonException ex)
            {
                _httpRequest.Dispose();
        ...
        public async Task<AzureOperationResponse<Transformation,TransformationsUpdateHeaders>> UpdateWithHttpMessagesAsync(Transformation transformation, string resourceGroupName, string jobName, string transformationName, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<Transformation,TransformationsUpdateHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<TransformationsUpdateHeaders>(JsonSerializer.Create(Client.DeserializationSettings));
            }
            catch (JsonException ex)
            {
                _httpRequest.Dispose();
        ...
        public async Task<AzureOperationResponse<Transformation,TransformationsGetHeaders>> GetWithHttpMessagesAsync(string resourceGroupName, string jobName, string transformationName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<Transformation,TransformationsGetHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<TransformationsGetHeaders>(JsonSerializer.Create(Client.DeserializationSettings));
            }
            catch (JsonException ex)
            {
                _httpRequest.Dispose();
