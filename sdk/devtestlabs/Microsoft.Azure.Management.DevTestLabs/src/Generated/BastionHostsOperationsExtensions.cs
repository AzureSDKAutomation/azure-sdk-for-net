...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    public static partial class BastionHostsOperationsExtensions
    {
            ...
            /// </param>
            public static BastionHost Get(this IBastionHostsOperations operations, string resourceGroupName, string labName, string virtualNetworkName, string name, string expand = default(string))
            {
                return operations.GetAsync(resourceGroupName, labName, virtualNetworkName, name, expand).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BastionHost> GetAsync(this IBastionHostsOperations operations, string resourceGroupName, string labName, string virtualNetworkName, string name, string expand = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetWithHttpMessagesAsync(resourceGroupName, labName, virtualNetworkName, name, expand, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
