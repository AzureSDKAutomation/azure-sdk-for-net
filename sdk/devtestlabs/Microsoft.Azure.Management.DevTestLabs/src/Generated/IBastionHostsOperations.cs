...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    public partial interface IBastionHostsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<BastionHost>> GetWithHttpMessagesAsync(string resourceGroupName, string labName, string virtualNetworkName, string name, string expand = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
