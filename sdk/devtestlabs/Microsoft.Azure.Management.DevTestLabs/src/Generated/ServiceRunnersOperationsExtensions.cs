...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    public static partial class ServiceRunnersOperationsExtensions
    {
            ...
            /// </param>
            public static ServiceRunner Get(this IServiceRunnersOperations operations, string resourceGroupName, string labName, string name, string expand = default(string))
            {
            ...
            /// </param>
            public static async Task<ServiceRunner> GetAsync(this IServiceRunnersOperations operations, string resourceGroupName, string labName, string name, string expand = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
