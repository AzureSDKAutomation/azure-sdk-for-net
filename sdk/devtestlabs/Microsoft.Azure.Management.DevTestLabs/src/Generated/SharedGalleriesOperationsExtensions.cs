...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    public static partial class SharedGalleriesOperationsExtensions
    {
            ...
            /// </param>
            public static SharedGallery Get(this ISharedGalleriesOperations operations, string resourceGroupName, string labName, string name, string expand = default(string))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SharedGallery> GetAsync(this ISharedGalleriesOperations operations, string resourceGroupName, string labName, string name, string expand = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
