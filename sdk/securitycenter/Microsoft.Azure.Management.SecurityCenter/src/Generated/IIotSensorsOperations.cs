...
namespace Microsoft.Azure.Management.Security
{
    ...
    public partial interface IIotSensorsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<IotSensorsModel>> CreateOrUpdateWithHttpMessagesAsync(string scope, string iotSensorName, string zone = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Delete IoT sensor
        /// </summary>
        /// <param name='scope'>
