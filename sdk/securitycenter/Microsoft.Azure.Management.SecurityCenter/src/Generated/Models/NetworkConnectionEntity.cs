...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class NetworkConnectionEntity : AlertEntity
    {
        ...
        /// (i.e. TCP, UDP)</param>
        public NetworkConnectionEntity(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), IPEntity sourceAddress = default(IPEntity), long? sourcePort = default(long?), IPEntity destinationAddress = default(IPEntity), long? destinationPort = default(long?), string protocol = default(string))
