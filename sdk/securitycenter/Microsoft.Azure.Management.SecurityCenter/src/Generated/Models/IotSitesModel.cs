...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class IotSitesModel : Resource
    {
        ...
        public IotSitesModel(string displayName, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), SystemData systemData = default(SystemData))
            : base(id, name, type)
        {
