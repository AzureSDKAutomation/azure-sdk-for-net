...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class IotAlert : Resource
    {
        ...
        public IotAlert(string id = default(string), string name = default(string), string type = default(string), string systemAlertId = default(string), string compromisedEntity = default(string), string alertType = default(string), string startTimeUtc = default(string), string endTimeUtc = default(string), IList<object> entities = default(IList<object>), object extendedProperties = default(object))
            : base(id, name, type)
        {
