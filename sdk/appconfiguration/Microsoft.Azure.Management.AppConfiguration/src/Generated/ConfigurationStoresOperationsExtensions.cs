...
namespace Microsoft.Azure.Management.AppConfiguration
{
    ...
    public static partial class ConfigurationStoresOperationsExtensions
    {
            ...
            /// </param>
            /// <param name='filter'>
            /// The filter to apply on the access keys. For example, you can use
            /// "$filter=readOnly eq true" to retrieve only read-only access keys.
            /// Properties that support filtering include 'name' and 'readOnly'.
            /// </param>
            public static IPage<ApiKey> ListKeys(this IConfigurationStoresOperations operations, string resourceGroupName, string configStoreName, string skipToken = default(string), string filter = default(string))
            {
                return operations.ListKeysAsync(resourceGroupName, configStoreName, skipToken, filter).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<ApiKey>> ListKeysAsync(this IConfigurationStoresOperations operations, string resourceGroupName, string configStoreName, string skipToken = default(string), string filter = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListKeysWithHttpMessagesAsync(resourceGroupName, configStoreName, skipToken, filter, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
