...
namespace Microsoft.Azure.Management.Peering
{
    ...
    /// </summary>
    internal partial class LookingGlassOperations : IServiceOperations<PeeringManagementClient>, ILookingGlassOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<LookingGlassOutput>> InvokeWithHttpMessagesAsync(string command, string sourceType, string sourceLocation, string destinationIP, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (command == null)
            {
            ...
            if (command != null)
            {
                _queryParameters.Add(string.Format("command={0}", System.Uri.EscapeDataString(Rest.Serialization.SafeJsonConvert.SerializeObject(command, Client.SerializationSettings).Trim('"'))));
            }
            if (sourceType != null)
            {
                _queryParameters.Add(string.Format("sourceType={0}", System.Uri.EscapeDataString(Rest.Serialization.SafeJsonConvert.SerializeObject(sourceType, Client.SerializationSettings).Trim('"'))));
            }
            if (sourceLocation != null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<LookingGlassOutput>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<LookingGlassOutput>(_responseContent, Client.DeserializationSettings);
                }
