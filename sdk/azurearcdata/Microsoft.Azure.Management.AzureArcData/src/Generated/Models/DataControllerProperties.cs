...
namespace Microsoft.Azure.Management.AzureArcData.Models
{
    ...
    public partial class DataControllerProperties
    {
        ...
        public DataControllerProperties(OnPremiseProperty onPremiseProperty = default(OnPremiseProperty), object k8sRaw = default(object), System.DateTime? lastUploadedDate = default(System.DateTime?), BasicLoginInformation basicLoginInformation = default(BasicLoginInformation), UploadServicePrincipal uploadServicePrincipal = default(UploadServicePrincipal), string provisioningState = default(string))
        {
