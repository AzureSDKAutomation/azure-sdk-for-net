...
namespace Microsoft.Azure.Management.AzureArcData.Models
{
    ...
    public partial class PostgresInstance : TrackedResource
    {
        ...
        /// resource.</param>
        public PostgresInstance(string location, PostgresInstanceProperties properties, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), SystemData systemData = default(SystemData), ExtendedLocation extendedLocation = default(ExtendedLocation))
