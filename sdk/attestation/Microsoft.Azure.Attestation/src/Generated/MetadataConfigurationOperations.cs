...
namespace Microsoft.Azure.Attestation
{
    ...
    /// </summary>
    internal partial class MetadataConfigurationOperations : IServiceOperations<AttestationClient>, IMetadataConfigurationOperations
    {
        /// <summary>
        /// Initializes a new instance of the MetadataConfigurationOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal MetadataConfigurationOperations(AttestationClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<object>> GetWithHttpMessagesAsync(string instanceUrl, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (instanceUrl == null)
            {
            ...
            var _url = _baseUrl + (_baseUrl.EndsWith("/") ? "" : "/") + ".well-known/openid-configuration";
