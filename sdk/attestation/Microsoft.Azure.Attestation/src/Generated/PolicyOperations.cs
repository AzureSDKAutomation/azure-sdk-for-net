...
namespace Microsoft.Azure.Attestation
{
    ...
    internal partial class PolicyOperations : IServiceOperations<AttestationClient>, IPolicyOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<PolicyResponse>> GetWithHttpMessagesAsync(string instanceUrl, string attestationType, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (instanceUrl == null)
            {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "attestationType");
            }
            // Tracing
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("attestationType", attestationType);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "Get", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri;
            var _url = _baseUrl + (_baseUrl.EndsWith("/") ? "" : "/") + "policies/{attestationType}";
            _url = _url.Replace("{instanceUrl}", instanceUrl);
            _url = _url.Replace("{attestationType}", System.Uri.EscapeDataString(attestationType));
            ...
            // Create Result
            var _result = new AzureOperationResponse<PolicyResponse>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<PolicyResponse>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<PolicyResponse>> SetWithHttpMessagesAsync(string instanceUrl, string attestationType, string newAttestationPolicy, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (instanceUrl == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "instanceUrl");
            ...
            if (newAttestationPolicy != null)
            {
                if (!System.Text.RegularExpressions.Regex.IsMatch(newAttestationPolicy, "[A-Za-z0-9_-]+\\.[A-Za-z0-9_-]*\\.[A-Za-z0-9_-]*"))
                {
                    throw new ValidationException(ValidationRules.Pattern, "newAttestationPolicy", "[A-Za-z0-9_-]+\\.[A-Za-z0-9_-]*\\.[A-Za-z0-9_-]*");
                }
            }
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<PolicyResponse>> ResetWithHttpMessagesAsync(string instanceUrl, string attestationType, string policyJws, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (instanceUrl == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "instanceUrl");
            ...
            if (policyJws != null)
            {
                if (!System.Text.RegularExpressions.Regex.IsMatch(policyJws, "[A-Za-z0-9_-]+\\.[A-Za-z0-9_-]*\\.[A-Za-z0-9_-]*"))
                {
                    throw new ValidationException(ValidationRules.Pattern, "policyJws", "[A-Za-z0-9_-]+\\.[A-Za-z0-9_-]*\\.[A-Za-z0-9_-]*");
                }
            }
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri;
            var _url = _baseUrl + (_baseUrl.EndsWith("/") ? "" : "/") + "policies/{attestationType}:reset";
            _url = _url.Replace("{instanceUrl}", instanceUrl);
            _url = _url.Replace("{attestationType}", System.Uri.EscapeDataString(attestationType));
            List<string> _queryParameters = new List<string>();
            if (Client.ApiVersion != null)
