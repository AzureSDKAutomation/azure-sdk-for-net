...
namespace Microsoft.Azure.Attestation
{
    ...
    public partial class AttestationClient : ServiceClient<AttestationClient>, IAttestationClient, IAzureClient
    {
        ...
        /// </summary>
        public virtual IMetadataConfigurationOperations MetadataConfiguration { get; private set; }
        ...
        /// True: will dispose the provided httpClient on calling AttestationClient.Dispose(). False: will not dispose provided httpClient</param>
        protected AttestationClient(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// </param>
        protected AttestationClient(params DelegatingHandler[] handlers) : base(handlers)
        {
            Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        protected AttestationClient(HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : base(rootHandler, handlers)
        {
            Initialize();
        }
        ...
        /// </exception>
        public AttestationClient(ServiceClientCredentials credentials, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (credentials == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AttestationClient(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AttestationClient(ServiceClientCredentials credentials, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
