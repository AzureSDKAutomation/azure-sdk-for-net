      ...
      public static IEnumerable<Tuple<string, string, string>> ApiInfo_AzureMediaServices
      {
          get
          {
              return new Tuple<string, string, string>[]
              {
                ...
                new Tuple<string, string, string>("Media", "Locations", "2021-05-01"),
                new Tuple<string, string, string>("Media", "Mediaservices", "2021-05-01"),
                new Tuple<string, string, string>("Media", "Operations", "2021-05-01"),
                new Tuple<string, string, string>("Media", "PrivateEndpointConnections", "2021-05-01"),
                new Tuple<string, string, string>("Media", "PrivateLinkResources", "2021-05-01"),
