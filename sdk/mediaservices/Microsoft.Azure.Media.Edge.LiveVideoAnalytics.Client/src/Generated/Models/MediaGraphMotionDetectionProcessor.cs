...
namespace Microsoft.Azure.Media.Edge.LiveVideoAnalytics.Client.Models
{
    ...
    public partial class MediaGraphMotionDetectionProcessor : MediaGraphProcessor
    {
        ...
        public MediaGraphMotionDetectionProcessor(string name, IList<MediaGraphNodeInput> inputs, MediaGraphMotionDetectionSensitivity? sensitivity = default(MediaGraphMotionDetectionSensitivity?), bool? outputMotionRegion = default(bool?))
            : base(name, inputs)
        {
