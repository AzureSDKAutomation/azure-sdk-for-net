...
namespace Microsoft.Azure.Management.RecoveryServices
{
    ...
    public partial class RecoveryServicesClient : ServiceClient<RecoveryServicesClient>, IRecoveryServicesClient, IAzureClient
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<Vault>> BeginGetOperationResultWithHttpMessagesAsync(string resourceGroupName, string vaultName, string operationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.SubscriptionId");
