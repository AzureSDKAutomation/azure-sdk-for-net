...
namespace Microsoft.Azure.Management.IotHub.Models
{
    ...
    public partial class ImportDevicesRequest
    {
        ...
        public ImportDevicesRequest(string inputBlobContainerUri, string outputBlobContainerUri, string inputBlobName = default(string), string outputBlobName = default(string), string authenticationType = default(string), bool? includeConfigurations = default(bool?), string configurationsBlobName = default(string), ManagedIdentity identity = default(ManagedIdentity))
        {
