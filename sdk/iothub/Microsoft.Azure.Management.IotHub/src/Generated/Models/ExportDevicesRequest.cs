...
namespace Microsoft.Azure.Management.IotHub.Models
{
    ...
    public partial class ExportDevicesRequest
    {
        ...
        public ExportDevicesRequest(string exportBlobContainerUri, bool excludeKeys, string exportBlobName = default(string), string authenticationType = default(string), bool? includeConfigurations = default(bool?), string configurationsBlobName = default(string), ManagedIdentity identity = default(ManagedIdentity))
        {
