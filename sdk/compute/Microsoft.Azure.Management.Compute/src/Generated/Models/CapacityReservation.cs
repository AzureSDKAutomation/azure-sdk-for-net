...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class CapacityReservation : Resource
    {
        ...
        /// reservation. The zone has to be single value and can be assigned
        /// only during creation. If not provided, the reservation supports
        /// only non-zonal deployments. If provided, enforces VM/VMSS using
        /// this capacity reservation to be in same zone.</param>
        ...
        /// only during creation. If not provided, the reservation supports
        /// only non-zonal deployments. If provided, enforces VM/VMSS using
        /// this capacity reservation to be in same zone.
        /// </summary>
